...
===========
 ...
 to develop code for a Embedded Artsists LPC313x evaluation board. It implements
 USB HID mouse.
...
===============
  ...
  2) Select File->Open->Workspace...
     ...
     <installation-root>\arm\examples\NXP\LPC313x\EmbArtLPC313x\USBMouse\USBMouse.eww
