/***********************************************************************
 * $Id: lpc313x_i2c_driver.c 28 2014-01-27 14:45:13Z danielru $
 *
...
void enable_i2c_irq_int(UNS_32 devid)
{
  ...
  if (i2c_id == 0)
  {
    INTC_IntEnable(I2C0_NINTR,1);
  }
  else if (i2c_id == 1)
  {
    INTC_IntEnable(I2C1_NINTR,1);
  }
  return;
}
...
void disable_i2c_irq_int(UNS_32 devid)
{
  ...
  if (i2c_id == 0)
  {
    INTC_IntEnable(I2C0_NINTR,0);
  }
  else if (i2c_id == 1)
  {
    INTC_IntEnable(I2C1_NINTR,0);
  }
  return;
}
...
void i2c_mtxrx_handler(INT_32 devid)
{
  ...
  else if (((device->regptr->sts & I2C_STS_TDI) != 0) && ((device->regptr->sts & I2C_STS_RFE) != 0) )
  {
    /* clear the TDI bit */
    device->regptr->sts |= I2C_STS_TDI;
    /* update status */
