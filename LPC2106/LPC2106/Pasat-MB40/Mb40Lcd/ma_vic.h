...
**      Filename    : ma_vic.h
**
**      Abstract    : This is the device driver header file for the VIC
**                    module.
**
...
#ifndef _IS_INCLUDED_VIC_H
#define _IS_INCLUDED_VIC_H
...
extern void MA_Init_VIC( void );
extern void MA_SetISRAddress_VIC( U8 *ISRAddress, U8 SlotNr );
extern __irq __arm void  IRQ_Handler( void );
