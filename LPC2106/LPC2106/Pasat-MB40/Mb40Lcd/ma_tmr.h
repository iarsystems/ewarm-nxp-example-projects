...
**      Filename    : ma_tmr.h
**
**      Abstract    : This is the device driver header file for the TIMER 
**                    module.
**
...
#ifndef _IS_INCLUDED_TIMER_H
#define _IS_INCLUDED_TIMER_H
...
extern void MA_Init_TIMER( void );
extern void MA_Reset_TIMER( void );
extern S8 MA_Start_TIMER( U8 Channel, U8 Reset );
extern S8 MA_Stop_TIMER( U8 Channel );
extern U32 MA_Read_TIMER( U8 Channel );
extern void MA_IntHandler_TIMER1( void );
