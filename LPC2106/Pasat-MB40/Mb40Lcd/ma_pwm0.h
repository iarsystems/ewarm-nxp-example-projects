...
**      Filename    : ma_pwm0.h
**
**      Abstract    : This is the device driver header file for the PWM0 
**                    module.
**
...
#ifndef _IS_INCLUDED_PWM0_H
#define _IS_INCLUDED_PWM0_H
...
extern void MA_Init_PWM0( void );
extern void MA_Reset_PWM0( void );
extern S8 MA_Start_PWM0( U8 Reset );
extern S8 MA_Stop_PWM0( void );
extern S8 MA_Set_PWM0( U8 Channel, U8 EnableLatch, U32 Value );
