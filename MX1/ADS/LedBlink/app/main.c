 ...
 * to develop code for the Freescale MX1 ADS evaluation board based on
 * MC9328MX1. It shows basic use of I/O, timer and the interrupt controller.
...
Int32U LedState;
  ...
  DDIR_A |= LED_PA2 | LED_PA23;   // set PA2, PA23 as outputs
  ...
  TCMP2 = (unsigned int) PERCLK1 / TICK_PER_SEC; // Init the Timer's period
