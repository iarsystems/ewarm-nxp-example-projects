 ...
 *
 *    File name   : arm720t_cp15_drv.h
 *    Description : Definitions of the driver for the ARM720T's CP15
 *
 *    History :
 *    1. Date        : May, 10 2006
...
#ifndef __ARM720T_CP15_DRV_H
#define __ARM720T_CP15_DRV_H

#define NON_CACHABLE_ADDR     0xFFFFFFFC
#define ARM720T_REV           3
...
#define CP15_CTRL_C      (1UL <<  2)    // Cache enable/disable
#define CP15_CTRL_W      (1UL <<  3)    // Write buffer enable/disable
#define CP15_CTRL_P      (1UL <<  4)
#define CP15_CTRL_D      (1UL <<  5)
#define CP15_CTRL_L      (1UL <<  6)
