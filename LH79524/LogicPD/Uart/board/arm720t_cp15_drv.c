 ...
 *
 *    File name   : arm720t_cp15_drv.c
 *    Description : Driver for the ARM720T's CP15
 *
 *    History :
 *    1. Date        : May, 10 2006
...
{
register volatile Int32U Addr = (Int32U)pAddr;
  __MCR(15,0,Addr,CP15_TBL_OPR,7,1);
}
...
{
register volatile Int32U Dummy = *(pInt32U)NON_CACHABLE_ADDR;
}
