...
===========
 ...
 to develop code for IAR LPC-2378-SK board.
...
===============
  ...
  2) Select File->Open->Workspace...
     ...
     LPC23xx\IAR-LPC-2378-SK\AudioDevice\AudioDevice.eww

  3) Connect a headset to MIC and HEADPHONE connectors of the IAR LPC-P2378-SK
     board.
