...
===========
  ...
  ARM to develop code for IAR LPC-2378-SK evaluation boards. This demo 
  shows a web server  application  running on the top of the uIP 1.0 
  TCP-IP stack.
   This example can work standalone on IAR LPC-2378-SK board.
...
===============
  ...
  2) Select File->Open->Workspace...
     ...
     LPC23xx\IAR-LPC-2378-SK\uip_webserver\uip_webserver.eww

  3) Run the program.

  4) Connect cable between PC LAN Card or Hub and IAR LPC-2378-SK board.
