                          ...
                          bool WakeupEnable)
{
  ...
  case USBWAKE:
    ...
    // Set Wake-up
    if (WakeupEnable)
      EXTWAKE_bit.USBWAKE = 1;
    else
      EXTWAKE_bit.USBWAKE = 0;
    break;
    */
  case BODWAKE:
    // Set Wake-up
    if (WakeupEnable)
      EXTWAKE_bit.BODWAKE = 1;
    else
      EXTWAKE_bit.BODWAKE = 0;
    break;
  case RTCWAKE:
    // Set Wake-up
    if (WakeupEnable)
      EXTWAKE_bit.RTCWAKE = 1;
    else
      EXTWAKE_bit.RTCWAKE = 0;
    break;
  default:
    return 1;
  }
