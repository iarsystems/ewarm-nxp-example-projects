...
**      Filename    : ma_gpio.h
**
**      Abstract    : This is the device driver header file for the GPIO 
**                    module.
**
...
#ifndef _IS_INCLUDED_GPIO_H
#define _IS_INCLUDED_GPIO_H
...
extern void MA_Init_GPIO( void );
extern void MA_Reset_GPIO( void );
extern S8 MA_SetPortIn_GPIO( U32 BitMask );
extern S8 MA_SetPortOut_GPIO( U32 BitMask );
extern U32 MA_ReadPort_GPIO( void );
extern S8 MA_WritePort_GPIO( U32 Value, U32 BitMask );
