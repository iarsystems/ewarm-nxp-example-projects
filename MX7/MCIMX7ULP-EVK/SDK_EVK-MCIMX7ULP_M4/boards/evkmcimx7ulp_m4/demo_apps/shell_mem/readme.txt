...
please do not use "flasherase" and "flashwrite" command to do some opperation from the offset address 0x to 0x10000.
This range is reserved for the application data image. ####
