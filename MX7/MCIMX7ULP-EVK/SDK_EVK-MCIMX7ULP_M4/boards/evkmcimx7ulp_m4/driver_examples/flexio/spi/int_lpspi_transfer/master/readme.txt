Overview
========
The flexio_spi_master_interrupt_lpspi_master example shows how to use flexio spi master driver in interrupt way:
...
- J8-3, R101 pad1(On base board) connected
- J8-4, R22(On base board) connected
- J8-5, TP25(On base board) connected
- J8-6, TP27(On base board) connected
