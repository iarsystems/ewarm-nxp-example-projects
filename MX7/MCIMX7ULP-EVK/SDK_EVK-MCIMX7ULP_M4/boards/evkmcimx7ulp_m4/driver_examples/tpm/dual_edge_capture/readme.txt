...
Board settings
==============
- Connect input signal to TP45(PTA31).Please note this test point is on the back of the base board.

- Make sure the input signal is connected to the TP45 before running this application.
