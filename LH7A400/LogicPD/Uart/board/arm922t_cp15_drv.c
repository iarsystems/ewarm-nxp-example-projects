 ...
 *
 *    File name   : arm922t_cp15_drv.c
 *    Description : Driver for the ARM922T's CP15
 *
 *    History :
 *    1. Date        : May, 14 2006
 ...
 * Return: none
 *
 * Description: Set CP15 doamin access register
 *
 *************************************************************************/
...
{
Int32U Val = CP15_GetStatus() & 0xC0000000;
  Val |= (Int32U)Mode << 30;
  CP15_SetMmu(Val);
}
...
{
ClkMode_t Val = (ClkMode_t)((CP15_GetStatus() & 0xC0000000) >> 30);
  return(Val);
}
