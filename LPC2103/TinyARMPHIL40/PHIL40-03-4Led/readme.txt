...
// Code is placed in Flash - Workspace: S1_Flash.eww
// Code is placed in Ram   - Workspace: S1_Ram.eww	(Start = 0x40000200)
...
//3. The codes assumes that there are 4 LED diodes connected to LPC2103
//   I/O ports P0.28 to P0.31. They are switched on and off - one after another.
