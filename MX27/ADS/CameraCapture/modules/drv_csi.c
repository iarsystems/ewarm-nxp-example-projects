...
Int8U Csi_Data[2];
  ...
  // Set PERDIV4 ~ 53MHz
  PCDR1_bit.PERDIV4 = 5 - 1;
  PCCR1_bit.PERCLK4_EN = 1;
  PCCR1_bit.HCLK_CSI = 1;
  ...
  PCCR1_bit.HCLK_EMMA = 1;        // Enable EMMA AHB clock input
  ...
  // The PrP place data direclty to the LCD's buffer
  ...
  Csi_Data[0] = 0x00;
  I2C1_Transfer(CSI_SLAVE_ADDR,1,Csi_Data,2);
  Csi_Data[1] = 0x01; // reset
  Csi_Data[0] = 0x00;
  I2C1_Transfer(CSI_SLAVE_ADDR,13,Csi_Data,2);
  ...
  Csi_Data[1] = 0x01; // reset
  Csi_Data[0] = 0x00;
  I2C1_Transfer(CSI_SLAVE_ADDR,7,Csi_Data,2);
  Csi_Data[1] = 0x00; // release
  Csi_Data[0] = 0x00;
  I2C1_Transfer(CSI_SLAVE_ADDR,7,Csi_Data,2);
  // Vertical flip
  ...
  Csi_Data[0] = 0x00;
  I2C1_Transfer(CSI_SLAVE_ADDR,1,Csi_Data,2);
  I2C1_Transfer(CSI_SLAVE_ADDR|1,32,Csi_Data,2);
  Csi_Data[0] |= 0x80;
  I2C1_Transfer(CSI_SLAVE_ADDR,32,Csi_Data,2);
  Csi_Data[1] = 0x01; // select IFP registers
  Csi_Data[0] = 0x00;
  I2C1_Transfer(CSI_SLAVE_ADDR,1,Csi_Data,2);
  I2C1_Transfer(CSI_SLAVE_ADDR|1,8,Csi_Data,2);
  Csi_Data[1] |= 0x02;
  I2C1_Transfer(CSI_SLAVE_ADDR,8,Csi_Data,2);
