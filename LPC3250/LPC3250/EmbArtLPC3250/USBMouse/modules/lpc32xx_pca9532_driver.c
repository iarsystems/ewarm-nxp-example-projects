/***********************************************************************
 * $Id: lpc32xx_pca9532_driver.c 28 2014-01-27 14:45:13Z danielru $
 *
...
#include "lpc32xx_pca9532_driver.h"

#define PCA9532_ADDR0	0x60
#define DATA_LENGTH		16

/* I2C driver data for I2C1 and device handle */
...
INT_32 pca9532_open(void *ipbase, INT_32 arg)
{
  ...
  /* formally assign a 7-bit slave address 0x60 to I2C1    */
 ...
 *
 **********************************************************************/
STATUS_T pca9532_close(INT_32 devid)
{
 ...
 *
 **********************************************************************/
STATUS_T pca9532_ioctl(INT_32 devid, INT_32 cmd, INT_32 arg, INT_32 * val)
{
  ...
  if (((I2C_CFG_T *) devid)->regptr == I2C1) i2c_id = 0;
  if (((I2C_CFG_T *) devid)->regptr == I2C2) i2c_id = 1;
