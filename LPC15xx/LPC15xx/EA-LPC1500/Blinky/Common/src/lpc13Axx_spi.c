/**********************************************************************
* $Id: lpc13Axx_spi.c 28 2014-01-27 14:45:13Z danielru $		lpc13Axx_spi.c		2011-06-02
*//**
* @file		lpc13Axx_spi.c
* @brief	Contains all functions support for SSP firmware library on lpc13Axx
* @version	1.0
* @date		02. June. 2011
...
void SPI_Init( LPC_SPI_TypeDef *SPIx, uint32_t div, uint32_t cfg, uint32_t dly )
{
	...
	{
		/* Enable SPI clock */
		LPC_SYSCON->SYSAHBCLKCTRL1 |= EN1_SPI0;
		/* Peripheral reset control to SPI, a "1" bring it out of reset. */
		LPC_SYSCON->PRESETCTRL1 |= EN1_SPI0;
		LPC_SYSCON->PRESETCTRL1 &= ~EN1_SPI0;
	...
	{
		/* Enable SPI clock */
		LPC_SYSCON->SYSAHBCLKCTRL1 |= EN1_SPI1;
		/* Peripheral reset control to SPI, a "1" bring it out of reset. */
		LPC_SYSCON->PRESETCTRL1 |= EN1_SPI1;
		LPC_SYSCON->PRESETCTRL1 &= ~EN1_SPI1;
	}
	if ( cfg & CFG_MASTER )
	{
