...
#define EP_MSK_ISO  (0x1<<4)      /* Isochronous Endpoint Logical Address Mask */
...
void USB_HwInit(void)
{
  ...
  /*Power up USB PHY*/
  LPC_SYSCON->PDRUNCFG &= ~CLKPWR_PDRUNCFG_USBPAD;
...
//  to FIQ. */
//  USB->USBFIQSelect = 0x01;				/* SOF Use FIQ */
//
