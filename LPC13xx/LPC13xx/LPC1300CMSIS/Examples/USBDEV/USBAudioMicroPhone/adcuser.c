...
//            	*((__attribute__((packed)) WORD *)EP0Buf) = VolCur;
              return (TRUE);
            case AUDIO_REQUEST_GET_MIN:
              *((__packed WORD *)EP0Buf) = VolMin;
//            	*((__attribute__((packed)) WORD *)EP0Buf) = VolMin;
              return (TRUE);
            case AUDIO_REQUEST_GET_MAX:
              *((__packed WORD *)EP0Buf) = VolMax;
//            	*((__attribute__((packed)) WORD *)EP0Buf) = VolMax;
              return (TRUE);
            case AUDIO_REQUEST_GET_RES:
              *((__packed WORD *)EP0Buf) = VolRes;
//            	*((__attribute__((packed)) WORD *)EP0Buf) = VolRes;
              return (TRUE);
          }
          break;
      }
...
//            	VolCur = *((__attribute__((packed)) WORD *)EP0Buf);
              return (TRUE);
          }
          break;
      }
