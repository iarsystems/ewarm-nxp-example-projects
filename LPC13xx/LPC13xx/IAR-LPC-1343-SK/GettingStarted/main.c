 ...
 *     to develop code for IAR-LPC-1343-SK board. It shows basic use of I/O,
 ...
 *              Sys clock is Sys PLL output and  AHB devider is 1
...
int cpuclk;
  ...
  while(1)
  {
    ...
    /**/
    sprintf(buf,"%.1f\260C",
             TempConverter(NtcRatioToTemperature((float)AD0DR7_bit.RESULT/(1024-1)),KELVIN,CELSIUS));
    /*Perint result*/
    printf("Temp %s       \r",buf);
    ...
    sprintf(buf,"%3d%%",(AD0DR6_bit.RESULT*100)/(1024-1));
    /*Print result*/
