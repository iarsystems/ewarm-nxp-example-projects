...
// for something else
static __no_init UNSIGNED8 mSectorMemory1[SECTOR_SIZE] @ SECTOR1_STARTADDR;
static __no_init UNSIGNED8 mSectorMemory2[SECTOR_SIZE] @ SECTOR2_STARTADDR;
