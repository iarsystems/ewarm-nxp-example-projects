 ...
 * Parameters: uint8_t * AddCount, Int32U MaxDly
 * Return: HD44780_ERROR_CODE_DEF
 *         HD44780_OK  0: Pass
 ...
 * Parameters: int32_t DisplayOn, int8_t DisplayShift
 * Return: HD44780_ERROR_CODE_DEF
 *         HD44780_OK  0: Pass
 *       HD44780_ERROR 1: Busy check Time Out
 ...
 *
 *************************************************************************/
HD44780_ERROR_CODE_DEF HD44780_DisplayShift (int32_t DisplayOn, int8_t DisplayShift)
{
uint8_t ShiftDir;
  if (DisplayShift >= 0)
  {
 ...
 * Parameters: int32_t CursorOn,int32_t CursorBlink,
 ...
 *
 *************************************************************************/
HD44780_ERROR_CODE_DEF HD44780_CursorPosSet (int32_t CursorOn,int32_t CursorBlink, HD44780_XY_DEF X, HD44780_XY_DEF Y)
{
uint8_t CursorPos;
  /* Find Address by coordinate */
