...
===========
 ...
 develop code for IAR-LPC-1343-SK board. It describes the implementation and
 ...
 application note and is ported for EWARM and IAR-LPC-1343-SK board
 
COMPATIBILITY
=============

   The example project is compatible with IAR-LPC-1343-SK evaluation board.
...
===============
 ...
 1. Open the  LPC1343 FlashNVol workspace.
