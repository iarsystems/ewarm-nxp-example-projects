...
/**
 * @brief	Set MCLK clock source
 * @param	src	: Clock source for MCLK (See #CHIP_SYSCON_MCLKSRC_T)
 * @return	Nothing
 * @note	To disable clock source to MCLK use #SYSCON_MCLKSRC_DISABLED as the
 * argument to this API.
 */
__STATIC_INLINE void Chip_Clock_SetMCLKSource(CHIP_SYSCON_MCLKSRC_T src)
{
