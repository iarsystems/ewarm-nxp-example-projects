...
#ifndef __TIMER_5411X_H_
#define __TIMER_5411X_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup TIMER_5411X CHIP: LPC5411X 32-bit Timer driver
...
__STATIC_INLINE void Chip_TIMER_Init(LPC_TIMER_T *pTMR)
{
	switch((uint32_t) pTMR) {
		...
		default:
			/* BUG: Application has provided wrong timer base address */
			return;
	}
}
