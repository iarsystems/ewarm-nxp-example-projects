Overview
========
This SCTIMer project (lpc_sctimer_pwm_change) is a demonstration program of the 
SDK SCTimer driver's PWM generation. It sets up a PWM signal and periodically 
updates the PWM signals dutycycle.
