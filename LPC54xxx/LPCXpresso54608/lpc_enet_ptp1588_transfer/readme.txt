...
The lpc_enet_ptp1588_transfer example shows the way to use ENET driver to  
...
(the outside loopback cable can be used to see the right rx time-stamping log since we send the ptp message). 
