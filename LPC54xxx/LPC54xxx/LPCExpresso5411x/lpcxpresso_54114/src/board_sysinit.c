...
STATIC const PINMUX_GRP_T pinmuxing[] = {
	...
	{0, 0,	IOCON_MODE_INACT | IOCON_FUNC1 | IOCON_DIGITAL_EN | IOCON_INPFILT_OFF}, /* UART RX */
	{0, 1,	IOCON_MODE_INACT | IOCON_FUNC1 | IOCON_DIGITAL_EN | IOCON_INPFILT_OFF}, /* UART TX */
#if 0
	/* UART0 */
...
{
	/* Set the power mode */
	Chip_POWER_SetVoltage(BOARD_POWERMODE, BOARD_MAINCLOCKRATE);
