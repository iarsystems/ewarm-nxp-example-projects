Overview
========
The I2C Example project lpc_i2c_polling is a demonstration program that uses the 
KSDK software transfer data over Inter-Integrated Circuit interface. The example
uses the one i2c instance as the master to send data to another i2c instance as the slave.
