Overview
========
The SCTImer multi-state project (lpc_sctimer_multi_state_pwm) is a demonstration
program of the SCTimer state machine. It shows how to set up events to be triggered
