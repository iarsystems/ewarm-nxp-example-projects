...
======================================================================
- Reprogramming of the FAIM memory with hastily chosen values can render your device uncommunicative!
  An uncommunicative device may not be recoverable.
...
- In the main file, there is a global array variable 'faim_write_data' which is declared and initialized.
  ...
  -- After a reset, will a reprogrammed low power start bit take effect.
