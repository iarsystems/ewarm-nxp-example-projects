/**************************************************************************************************
 *   readme.txt:  Description of the LPC8xx Example Software Package
 *
 *   Copyright(C) 2012, NXP Semiconductor
 *   All rights reserved.
 *
 *   History
 *   2012.11.15  ver 1.01    Removed unused common driver files
 *			     Updated Abstract for SPI
 *
 *   2012.11.13  ver 1.00    Preliminary version, first Release. 
 *        
 *
 *
**************************************************************************************************/
...
LPC8xx family microcontrollers.
