...
typedef struct
{
  ...
  __IO uint32_t FAIMCTRL            ; ///< (0x03C) FAIM row protect control 0xFF
  ...
  __IO uint32_t RESERVED4a[1]       ; ///< (0x060) 
  ...
  __IO uint32_t RESERVED6[1]        ; ///< (0x0BC)
  __IO uint32_t EFLASHREFCLKDIV     ; ///< (0x0C0) EFLASH reference clock divider
  __IO uint32_t FAIMREFCLKDIV       ; ///< (0x0C4) FAIM reference clock divider
  __IO uint32_t RESERVED7[2]        ; ///< (0x0C8 - 0x0CC)
...
//------------------------ FAIM Controller -------------------------
typedef struct {
  __IO uint32_t  EECMD;           // 0x00
  __I  uint32_t  Reserved0;       // 0x04
  __IO uint32_t  EERWSTATE;       // 0x08
  __IO uint32_t  EEPAUTOPROG;     // 0x0C
  __IO uint32_t  EEWSTATE;        // 0x10
  __IO uint32_t  EECLKDIV;        // 0x14
  __IO uint32_t  EEPWRDWN;        // 0x18
  __IO uint32_t  EEMSSTART;       // 0x20
  __IO uint32_t  EEMSSTOP;        // 0x24
  __I  uint32_t  EEMSDATASIG;     // 0x28
  __I  uint32_t  EEMSPARSIG;      // 0x2C
  __IO uint32_t  EEFEATURE;       // 0x30
  __I  uint32_t  EESTATUS;        // 0x34
  __IO uint32_t  ECCRSTERRCNT;    // 0x38
  __I  uint32_t  ECCERRCNT;       // 0x3C
  __I  uint32_t  Reserved1[5];    // 0x40 - 0x50
  __IO uint32_t  EECLKDIV1;       // 0x54
  __IO uint32_t  EECLKDIV2;       // 0x58
  __I  uint32_t  Reserved2[5];    // 0x5C - 0x6C
  __O  uint32_t  EEADDR;          // 0x70
  __I  uint32_t  Reserved3[3];    // 0x74 - 0x7C
  __O  uint32_t  EEWDATA;         // 0x80
  __I  uint32_t  Reserved4;       // 0x84
  __I  uint32_t  EERDATA;         // 0x88
} LPC_FAIMCTRL_TypeDef;
...
#define LPC_FAIMCTRL_BASE      (LPC_APB0_BASE + 0x10000)
...
#define LPC_FAIMCTRL          ((LPC_FAIMCTRL_TypeDef *) LPC_FAIMCTRL_BASE)
