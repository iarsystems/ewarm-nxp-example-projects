/*****************************************************************************
 *   can.h:  Header file for NXP LPC29xx Family Microprocessors
 *
...
/*
 * Bit Timing Values for 80MHz clk frequency
 */
#if 0
/* To be tested */
#define BITRATE100K80MHZ          0x00090041
#define BITRATE125K80MHZ          0x00090034
#define BITRATE250K80MHZ          0x00090019
#define BITRATE500K80MHZ          0x0009000C
#define BITRATE1000K80MHZ         0x00090006
#else
#define BITRATE100K80MHZ          0x002B0031
#define BITRATE125K80MHZ          0x002B0027
#define BITRATE250K80MHZ          0x002B0013
#define BITRATE500K80MHZ          0x002B0009
#define BITRATE1000K80MHZ         0x002B0004
#endif
...
/* Common CAN bit rates for 12.5Mhz(50Mhz CCLK/4) clock frequency */
...
/**
 * Bit Timing Values for 40MHz(80Mhz CCLK/2) clk frequency
 */
#define BITRATE100K40MHZ		0x001C0018
#define BITRATE125K40MHZ		0x001C0013
#define BITRATE250K40MHZ		0x001C0009
#define BITRATE500K40MHZ		0x001C0004
