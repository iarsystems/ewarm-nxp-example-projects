 ...
 *
 *    File name   : arm922t_cp15_drv.h
 *    Description : Definitions of the driver for the ARM922T's CP15
 *
 *    History :
 *    1. Date        : May, 14 2006
...
#define L1_SECTIONS_ENTRY(Numb, VirtAddr ,PhAddr, Domain,C,B) \
  { Numb, VirtAddr, PhAddr, ((Domain << 5) | (C << 3) | (B << 2) | TtL1Section)}
...
#define CP15_CTRL_NF     (1UL << 30)    // Fast bus
#define CP15_CTRL_IA     (1UL << 31)    // Asynchronous clock
...
/*************************************************************************
 * Function Name: CP15_SetClkMode
 * Parameters: ClkMode_t Mode
 *
 * Return: none
 *
 * Description: Set bus clock mode
 *
 *************************************************************************/
void CP15_SetClkMode (ClkMode_t Mode);
 ...
 * Return: ClkMode_t
 *
 * Description: Get bus clock mode
 *
 *************************************************************************/
ClkMode_t CP15_GetClkMode (void);
