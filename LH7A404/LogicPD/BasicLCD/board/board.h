...
#define STAT_LED1            (1UL << 7)
#define STAT_LED0            (1UL << 6)
...
#define STAT_LED0_ON()        GPIO_PED &= ~STAT_LED0
#define STAT_LED0_OFF()       GPIO_PED |=  STAT_LED0

#define STAT_LED1_ON()        GPIO_PED &= ~STAT_LED1
#define STAT_LED1_OFF()       GPIO_PED |=  STAT_LED1
