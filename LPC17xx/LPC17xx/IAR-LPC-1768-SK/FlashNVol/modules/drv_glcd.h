 ...
 * Parameters: puint32_t pXL, puint32_t pXR,
 *             puint32_t pYU, puint32_t pYD,
 *             puint32_t pH_Size, puint32_t pV_Size
 *
 * Return: int32_t
 ...
 *************************************************************************/
static
int32_t GLCD_TextCalcWindow (uint32_t * pXL, uint32_t * pXR,
