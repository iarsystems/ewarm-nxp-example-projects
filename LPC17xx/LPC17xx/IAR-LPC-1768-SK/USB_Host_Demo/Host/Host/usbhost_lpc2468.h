...
#ifndef USBHOST_LPC1768_H
#define USBHOST_LPC1768_H
...
#if PRINT_ENABLE
#define  PRINT_Log(...)       printf("\f"__VA_ARGS__)
#define  PRINT_Err(rc)        printf("\fERROR: In %s at Line %u - rc = %d\n\r", __FUNCTION__, __LINE__, rc)
...
#define  HcControl            *((volatile USB_INT32U*)((USB_INT32U)0x5000C004))
#define  HcCommandStatus      *((volatile USB_INT32U*)((USB_INT32U)0x5000C008))
#define  HcInterruptStatus    *((volatile USB_INT32U*)((USB_INT32U)0x5000C00C))
#define  HcInterruptEnable    *((volatile USB_INT32U*)((USB_INT32U)0x5000C010))
#define  HcHCCA               *((volatile USB_INT32U*)((USB_INT32U)0x5000C018))
#define  HcControlHeadED      *((volatile USB_INT32U*)((USB_INT32U)0x5000C020))
#define  HcBulkHeadED         *((volatile USB_INT32U*)((USB_INT32U)0x5000C028))
#define  HcFmInterval         *((volatile USB_INT32U*)((USB_INT32U)0x5000C034))
#define  HcRhStatus           *((volatile USB_INT32U*)((USB_INT32U)0x5000C050))
#define  HcRhPortStatus       *((volatile USB_INT32U*)((USB_INT32U)0x5000C054))
