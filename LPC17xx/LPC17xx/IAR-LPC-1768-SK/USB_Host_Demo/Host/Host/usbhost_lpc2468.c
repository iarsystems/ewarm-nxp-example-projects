...
void  Host_Init (void)
{
    ...
    Hcca       = (volatile  HCCA       *)0x2007C000;
    TDHead     = (volatile  HCTD       *)0x2007C100;
    TDTail     = (volatile  HCTD       *)0x2007C110;
    EDCtrl     = (volatile  HCED       *)0x2007C120;
    EDBulkIn   = (volatile  HCED       *)0x2007C130;
    EDBulkOut  = (volatile  HCED       *)0x2007C140;
    TDBuffer   = (volatile  USB_INT08U *)0x2007C150;
    FATBuffer  = (volatile  USB_INT08U *)0x2007C1D0;
    UserBuffer = (volatile  USB_INT08U *)0x2007D000;
