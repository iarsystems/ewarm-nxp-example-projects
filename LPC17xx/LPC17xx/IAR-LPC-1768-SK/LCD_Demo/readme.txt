...
===========
 ...
 to develop code for IAR-LPC1768-SK board. It shows basic use of the I/O,
 timer, interrupt controllers and LDC module for graphic and text drawing.
...
===============
  ...
  2) Select File->Open->Workspace...
     ...
     LPC17xx\IAR-LPC1768-SK\LCD_Demo\LCD_Demo.eww
