...
int I2C_InitMaster (unsigned long BusSpeed)
{
  ...
  I2C1SCLH = ((clk / BusSpeed) / 2) + 1;
  I2C1SCLL =  (clk / BusSpeed) / 2;

  if (I2C1SCLH < 4 || I2C1SCLL < 4)
    return 1;
...
{
unsigned long I2Cstatus = I2C1STAT & 0xF8;
