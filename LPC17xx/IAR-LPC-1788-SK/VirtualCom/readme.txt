...
===============
  ...
  2) Select File->Open->Workspace...
     ...
     \LPC17xx\IAR-LPC-1788-SK\VirtualCom\VirtualCom.eww
  ...
  6) Use a USB cable to connect the PC to the board's USB OTG connector.
     ...
     located in the $PROJ_DIR$\VirCOM_Driver\ folder.