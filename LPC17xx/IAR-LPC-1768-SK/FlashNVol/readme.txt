...
===========
 ...
 develop code for IAR-LPC-1768-SK board. It describes the implementation and
 ...
 application note and is ported for EWARM and IAR-LPC-1768-SK board
 
COMPATIBILITY
=============

   The example project is compatible with IAR-LPC-1768-SK evaluation board.
...
===============
 ...
 1. Open the  LPC1768 FlashNVol workspace.
 ...
 5. A counter showing the seconds is displayed on the LCD. The counter is stored in
    ...
    whole sector. The lifespan of the LPC1700 series microcontrollers flash is
