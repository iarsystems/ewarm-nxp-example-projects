...
int I2C_InitMaster (unsigned long BusSpeed)
{
  ...
  PCONP_bit.PCI2C2 = 1;      // enable I2C2 clock
  ...
  I2C2SCLH = ((SYS_GetFpclk(I2C2_PCLK_OFFSET) / BusSpeed) / 2) + 1;
  I2C2SCLL =  (SYS_GetFpclk(I2C2_PCLK_OFFSET) / BusSpeed) / 2;

  if (I2C2SCLH < 4 || I2C2SCLL < 4)
    return 1;
...
{
unsigned long I2Cstatus = I2C2STAT & 0xF8;
