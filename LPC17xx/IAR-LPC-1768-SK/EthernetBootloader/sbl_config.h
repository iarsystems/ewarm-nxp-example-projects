...
#define USB_LINK_LED_DIR   FIO1DIR
#define USB_LINK_LED_SET   FIO1SET
#define USB_LINK_LED_CLR   FIO1CLR
#define USB_LINK_LED_IO    FIO1PIN
// USB Link LED
#define USB_CONNECT_LED_MASK   (1UL<<9)
#define USB_CONNECT_LED_DIR   FIO2DIR
#define USB_CONNECT_LED_SET   FIO2SET
#define USB_CONNECT_LED_CLR   FIO2CLR
#define USB_CONNECT_LED_IO    FIO2PIN
// LED1
#define LED1_MASK   (1UL<<25)
#define LED1_DIR    FIO1DIR
#define LED1_SET    FIO1SET
#define LED1_CLR    FIO1CLR
#define LED1_IO     FIO1PIN
// LED2
#define LED2_MASK   (1UL<<4)
#define LED2_DIR    FIO0DIR
#define LED2_SET    FIO0SET
#define LED2_CLR    FIO0CLR
#define LED2_IO     FIO0PIN
			   /* Port 2 pin */
