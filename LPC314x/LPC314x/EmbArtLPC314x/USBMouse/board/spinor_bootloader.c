 ...
 *    Description : lpc314x SPI bootloader - initialize SDRAM, copy image from
...
void InitSDRAM(void)
{
  ...
  MPMCDynamicConfig0_bit.AM = 0x11;
  /*Buffer Disable*/
  ...
  volatile unsigned long Dummy = *(volatile unsigned int *)(SDRAM_BASE_ADDR | (0x23UL << 13));
  // NORM
