...
===========
  ...
  to develop code for a Embedded Artsists LPC314x evaluation board. It shows
...
===============
  ...
  2) Select File->Open->Workspace...
     ...
     <installation-root>\arm\examples\NXP\LPC314x\EmbArtLPC314x\GettingStarted\GettingStarted.eww
