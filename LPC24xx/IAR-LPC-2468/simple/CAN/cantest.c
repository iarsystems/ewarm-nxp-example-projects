/*****************************************************************************
 *   cantest.c:  CAN test module file for NXP LPC23xx/LPC24xx Family Microprocessors
 *
 ...
 *  CAN1 and CAN2 should be connected.
 *
...
int main( void )
{
  ...
  /* This test program is connect CAN1 and CAN2 on the IAR LPC-x2468-SK boards,
