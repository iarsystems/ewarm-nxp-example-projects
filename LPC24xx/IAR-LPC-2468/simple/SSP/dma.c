...
DWORD DMA_Init( DWORD ChannelNum, DWORD DMAMode )
{
  ...
  if ( ChannelNum == 0 )
  {
    ...
    if ( DMAMode == M2M )
    {
      ...
      DMACC0CONTROL = (DMA_SIZE & 0x0FFF) | (0x01 << 12) | (0x01 << 15)
    ...
    {
      /* Ch0 set for P2M transfer from SSP1 to memory. */
      DMACC0SRCADDR = DMA_SSP1DR;
      DMACC0DESTADDR = DMA_DST;
      /* The burst size is set to 8, the size is 8 bit too. */
      /* Terminal Count Int enable */
      DMACC0CONTROL = (DMA_SIZE & 0x0FFF) | (0x02 << 12) | (0x02 << 15)
  ...
  else if ( ChannelNum == 1 )
  {
    ...
    if ( DMAMode == M2M )
    {
      ...
      /* DMACC0CONTROL Count Int enable */
      DMACC1CONTROL = (DMA_SIZE & 0x0FFF) | (0x01 << 12) | (0x01 << 15)
        | (0x02 << 18) | (0x02 << 21) | (1 << 26) | (1 << 27) | 0x80000000;
    }
    else if ( DMAMode == M2P )
    {
