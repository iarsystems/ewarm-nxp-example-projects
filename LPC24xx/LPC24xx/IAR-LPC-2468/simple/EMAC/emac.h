...
/* For the EMAC test, there are two ways to test:
  ...
  When TX_ONLY is set to 1, it's a TX_ONLY packet from the IAR LPC-x2468-SK
  ...
  IAR LPC-x2468-SK board, use the traffic generator to send packets,
  as long as the destination address matches, IAR LPC-x2468-SK will
...
BOUNCE_RX test */
#define EMAC_DST_ADDR12		0x0000C2B7
#define EMAC_DST_ADDR34		0x0000D76A
#define EMAC_DST_ADDR56		0x00000B00
