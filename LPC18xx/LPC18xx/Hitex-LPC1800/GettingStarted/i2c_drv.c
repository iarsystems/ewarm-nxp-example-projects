 ...
 * Parameters: unsigned long BusSpeed, unsigned long ClockFreq
 *
 * Return: int
 *             	0: success
 ...
 *
 *************************************************************************/
int I2C_InitMaster (unsigned long BusSpeed, unsigned long ClockFreq)
{

  CCU1_CLK_APB1_I2C0_CFG_bit.RUN = 1;

  SFSI2C0_bit.SCL_EZI = 1;
  SFSI2C0_bit.SDA_EZI = 1;
  ...
  I2C0SCLH = ((ClockFreq / BusSpeed) / 2) + 1;
  I2C0SCLL =  (ClockFreq / BusSpeed) / 2;
