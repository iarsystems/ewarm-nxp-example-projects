/**********************************************************************
* $Id: Gpio_LedBlinky.c 28 2014-01-27 14:45:13Z danielru $		Gpio_LedBlinky.c	2011-06-02
*//**
...
#define LED_CONTROL_ALL_CONFIG_OUTPUT	0xFF
#define LED_CONTROL_CLEAR_ALL			0xFF
#define OUTPUT							0x01
#define INPUT							0x00
...
int c_entry (void) {                       /* Main Program                       */
	...
	{                           					// Loop forever
		msec = 100;
		while(msec);
		FIO_ByteClearValue(LED_CONTROL_PORT_NUM,LED_CONTROL_BYTE_NUM,1<<1);
		msec = 100;
		while(msec);
