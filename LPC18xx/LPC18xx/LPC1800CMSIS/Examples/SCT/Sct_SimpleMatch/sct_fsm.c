...
/* OUTPUT registers */
LPC_SCT->OUT[0].SET = 0x00000001;        /* CTOUT0 */
LPC_SCT->OUT[0].CLR = 0x00000004;
LPC_SCT->OUT[1].SET = 0x00000004;        /* CTOUT1 */
LPC_SCT->OUT[1].CLR = 0x00000010;
LPC_SCT->OUT[2].SET = 0x00000010;        /* CTOUT2 */
LPC_SCT->OUT[2].CLR = 0x00000008;
LPC_SCT->OUT[3].SET = 0x00000008;        /* CTOUT3 */
LPC_SCT->OUT[3].CLR = 0x00000002;
