 ...
 *****        LPC18xx EMAC Ethernet controller                *****
 *****                                                        *****
 ******************************************************************/
...
void Init_EMAC(void)
{
  ...
  scu_pinmux(0xC ,1 , MD_BUK, FUNC3); 	// ENET_MDC: PC_1 -> FUNC3
  scu_pinmux(0x1 ,17 , MD_BUK, FUNC3); 	// ENET_MDIO: P1_17 -> FUNC3 
  scu_pinmux(0x1 ,18 , MD_BUK, FUNC3); 	// ENET_TXD0: P1_18 -> FUNC3 
  scu_pinmux(0x1 ,20 , MD_BUK, FUNC3); 	// ENET_TXD1: P1_20 -> FUNC3
  scu_pinmux(0x1 ,19 , MD_BUK, FUNC0); 	// ENET_REF: P1_19 -> FUNC0 (default)
  scu_pinmux(0xC ,4 , MD_BUK, FUNC3); 	// ENET_TX_EN: PC_4 -> FUNC3
  scu_pinmux(0x1 ,15 , MD_BUK, FUNC3); 	// ENET_RXD0: P1_15 -> FUNC3
  scu_pinmux(0x0 ,0 , MD_BUK, FUNC2); 	// ENET_RXD1: P0_0 -> FUNC2	
  scu_pinmux(0x1 ,16 , MD_BUK, FUNC3); 	// ENET_CRS: P1_16 -> FUNC3
  scu_pinmux(0xC ,9 , MD_BUK, FUNC3); 	// ENET_RX_ER: PC_9 -> FUNC3
  scu_pinmux(0xC ,8 , MD_BUK, FUNC3); 	// ENET_RXDV: PC_8 -> FUNC3	 	

  
#if MII				  /*   Select MII interface       */				 // check MUXING for new Eagle...
  scu_pinmux(0xC ,6 , MD_BUK, FUNC3); 	// ENET_RXD2: PC_6 -> FUNC3
  scu_pinmux(0xC ,7 , MD_BUK, FUNC3); 	// ENET_RXD3: PC_7 -> FUNC3
  scu_pinmux(0xC ,0 , MD_BUK, FUNC3); 	// ENET_RXLK: PC_0 -> FUNC0 (default)	   // Working on FUNC3 ????
  scu_pinmux(0xC ,2 , MD_BUK, FUNC3); 	// ENET_TXD2: PC_2 -> FUNC3
  scu_pinmux(0xC ,3 , MD_BUK, FUNC3); 	// ENET_TXD3: PC_3 -> FUNC3
  scu_pinmux(0xC ,5 , MD_BUK, FUNC3); 	// ENET_TX_ER:  PC_5 -> FUNC3
  scu_pinmux(0x0 ,1 , MD_BUK, FUNC2); 	// ENET_COL:  P0_1 -> FUNC2
...
{
  unsigned short * piDest;                       // Pointer added to correct expression

  piDest = Dest;                                 // Line added
  while (Size > 1) {
