/**********************************************************************
* $Id: Emc_NorFlash.c 28 2014-01-27 14:45:13Z danielru $		Emc_NorFlash.c		2011-06-02
*//**
* @file		Emc_NorFlash.c
* @brief	This example describes how to use EMC to program LHF00L28
*			Nor Flash
* @version	1.0
* @date		02. June. 2011
...
int c_entry (void) {                       /* Main Program */
	...
	Init(0x1C000000, 120000000, 0x20000);
	/* Erase Sector 0 */
	_DBG("Press 1 to Erase Sector 0...\r\n");
	while(_DG!='1');
	if(EraseSector(0x1C000000 + 0x20000) != 0){
		_DBG("Error Erase Sector 0!!!!");
		while(1);
	}
