/**********************************************************************
* $Id: Adc_Polling.c 28 2014-01-27 14:45:13Z danielru $		Adc_Polling.c		2012-04-27
*//**
* @file		Adc_Polling.c
...
int c_entry(void)
{
	...
	ADC_IntConfig(_LPC_ADC,_ADC_INT,DISABLE);
	...
	while(1)
	{
		...
		while (!(ADC_ChannelGetStatus(_LPC_ADC,_ADC_CHANNEL,ADC_DATA_DONE)));
