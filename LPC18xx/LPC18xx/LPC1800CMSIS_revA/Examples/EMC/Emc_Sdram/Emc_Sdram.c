/**********************************************************************
* $Id: Emc_Sdram.c 28 2014-01-27 14:45:13Z danielru $		Emc_Sdram.c		2011-06-02
*//**
* @file		Emc_Sdram.c
...
" This example will fill then check the SDRAM content on LPC1800 Eval Board \n\r"
"********************************************************************************\n\r";
...
int c_entry (void) {                       /* Main Program */
	...
	_DBG("Core M3 Clk = ");
	_DBD32(CGU_GetPCLKFrequency(CGU_PERIPHERAL_M3CORE));

	if(CGU_GetPCLKFrequency(CGU_PERIPHERAL_M3CORE) > MAX_EMC_CLK){
