/**********************************************************************
* $Id: composite_usbdesc.c 28 2014-01-27 14:45:13Z danielru $		composite_usbdesc.c			2011-06-02
*//**
...
/* Interface 0, Alternate Setting 0, DFU Class */
  ...
  USB_DFU_IF_NUM,                    /* bInterfaceNumber */
...
/* Endpoint, HID Interrupt In */
  ...
  0x20,          /* 16ms */          /* bInterval */
	...
	USB_ENDPOINT_DESC_SIZE,            /* bLength */
	USB_ENDPOINT_DESCRIPTOR_TYPE,      /* bDescriptorType */
	CDC_CIF_EP_IN,                     /* bEndpointAddress */
	USB_ENDPOINT_TYPE_INTERRUPT,       /* bmAttributes */
	...
	USB_ENDPOINT_DESC_SIZE,            /* bLength */
	USB_ENDPOINT_DESCRIPTOR_TYPE,      /* bDescriptorType */
	CDC_BULK_EP_OUT,                   /* bEndpointAddress */
	USB_ENDPOINT_TYPE_BULK,            /* bmAttributes */
	...
	USB_ENDPOINT_DESC_SIZE,            /* bLength */
	USB_ENDPOINT_DESCRIPTOR_TYPE,      /* bDescriptorType */
	CDC_BULK_EP_IN,                    /* bEndpointAddress */
	USB_ENDPOINT_TYPE_BULK,            /* bmAttributes */
	WBVAL(USB_CDC_BUFSIZE),            /* wMaxPacketSize */
	0x00,                              /* bInterval: ignore for Bulk transfer */
/* Terminator */
