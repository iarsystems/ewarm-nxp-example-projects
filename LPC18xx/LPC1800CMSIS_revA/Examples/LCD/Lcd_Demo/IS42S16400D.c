/**********************************************************************
* $Id: IS42S16400D.c 28 2014-01-27 14:45:13Z danielru $		SDRAM_Init.c		2011-06-02
*//**
* @file		SDRAM_Init.c
...
void SDRAM_Init () {
	...
	pclk = CGU_GetPCLKFrequency(CGU_PERIPHERAL_M3CORE);	/* Set up EMC Controller */	LPC_EMC->STATICWAITRD2 = NS2CLK(pclk, 55);	LPC_EMC->STATICCONFIG2 = /*1<<19| */0x81;	LPC_EMC->STATICWAITOEN2 = NS2CLK(pclk, 10);	LPC_EMC->STATICWAITWEN2 = NS2CLK(pclk, 10);	LPC_EMC->STATICWAITPAG2 = NS2CLK(pclk, 55);	LPC_EMC->STATICWAITWR2 = NS2CLK(pclk, 55);	LPC_EMC->STATICWAITTURN2 = NS2CLK(pclk, 55);	/* Select EMC clock-out */
