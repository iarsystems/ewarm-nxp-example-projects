/**********************************************************************
* $Id: I2c_EmuMaster.c 28 2014-01-27 14:45:13Z danielru $		I2c_EmuMaster.c	  2012-05-15
*//**
...
//unsigned char lcd_configdata[128];
...
int c_entry(void)
{
  ...
  i2cemu_init();
	...
	_DBG_("Press '1' to write through I2C emulation...");
	while (_DG != '1');

  pca9532_init();
	

	_DBG_("Press '2' to read through I2C emulation ...");
	while (_DG != '2');
