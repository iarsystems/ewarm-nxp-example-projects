...
uint8_t menu[]=
	...
	"use C_CAN to transmit and receive Message from CAN Analyzer\n\r"
	"********************************************************************************\n\r";
...
void RX_callback(uint32_t msg_no){
	...
	CAN_Send(LPC_C_CAN0, 17, (uint32_t *)&recv_obj);
...
int c_entry(void) { /* Main Program */
	...
	CAN_Init(LPC_C_CAN0, CAN_BITRATE500K12MHZ, CLKDIV1 , TX_callback, RX_callback);
