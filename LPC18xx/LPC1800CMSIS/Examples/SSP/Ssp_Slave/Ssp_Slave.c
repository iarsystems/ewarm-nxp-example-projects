/**********************************************************************
* $Id: Ssp_Slave.c 28 2014-01-27 14:45:13Z danielru $		Ssp_Slave.c			2011-06-02
*//**
* @file		Ssp_Slave.c
...
int c_entry(void)
{
	...
	/* Configure SSP1 pins*/
	scu_pinmux(0xF,4,MD_BUK,FUNC0);	// 	func2=SSP1 SCK0
 	scu_pinmux(0xF,5,MD_BUK,FUNC2);	// 	func2=SSP1 SSEL0
 	scu_pinmux(0xF,6,MD_BUK,FUNC2);	// 	func2=SSP1 MISO0
 	scu_pinmux(0xF,7,MD_BUK,FUNC2);	// 	func2=SSP1 MOSI0
