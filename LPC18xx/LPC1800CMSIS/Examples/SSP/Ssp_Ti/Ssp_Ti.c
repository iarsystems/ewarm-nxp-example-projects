/**********************************************************************
* $Id: Ssp_Ti.c 28 2014-01-27 14:45:13Z danielru $		Ssp_Ti.c			2011-06-02
*//**
* @file		Ssp_Ti.c
...
"\t - MCU: LPC18xx \n\r"
"\t - Core: ARM Cortex-M3 \n\r"
"\t - Communicate via: UART1 - 115.200 kbps \n\r"
...
int c_entry(void)
{
	...
	/* Configure SSP0 pins*/
	scu_pinmux(0x3,3,MD_PLN,FUNC2);	// P3.3 connected to SCL/SCLK	func2=SSP0 SCK0
 	scu_pinmux(0x3,6,MD_PLN,FUNC2);	// P3.6 connected to nCS		func2=SSP0 SSEL0
 	scu_pinmux(0x3,7,MD_PLN,FUNC2);	// P3.7 connected to SO			func2=SSP0 MISO0
 	scu_pinmux(0x3,8,MD_PLN,FUNC2);	// P3.8 connected to nSI		func2=SSP0 MOSI0
 	/* Configure SSP1 pins*/
	scu_pinmux(0xF,4,MD_BUK,FUNC0);	//func0=SSP1 SCK1
 	scu_pinmux(0xF,5,MD_BUK,FUNC2);	//func2=SSP1 SSEL1
 	scu_pinmux(0xF,6,MD_BUK,FUNC2);	//func2=SSP1 MISO1
 	scu_pinmux(0xF,7,MD_BUK,FUNC2);	//func2=SSP1 MOSI1
