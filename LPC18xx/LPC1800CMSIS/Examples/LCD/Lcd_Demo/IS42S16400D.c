/**********************************************************************
* $Id: IS42S16400D.c 28 2014-01-27 14:45:13Z danielru $		uda1380.h				2011-06-02
*//**
* @file		uda1380.h
...
#define HITEX_LPC1800_BOARD
#ifdef HITEX_LPC1800_BOARD
#include "lpc18xx.h"
#include "lpc_types.h"
...
void SDRAM_Init () {
	...
	LPC_EMC->STATICWAITTURN2 = NS2CLK(pclk, 55);
