/**********************************************************************
* $Id: Uart_Rs485Master.c 28 2014-01-27 14:45:13Z danielru $		Uart_Rs485Master.c			2011-06-02
*//**
* @file		Uart_Rs485Master.c
* @brief	This example used to test RS485 functionality on UART0 of
* 			LPC18xx.In this case, RS485 function on UART0 acts as Master
* 			on RS485 bus.
* @version	1.0
* @date		02. June. 2011
...
int c_entry(void)
{
	 ...
	 */
	scu_pinmux(0x2 ,0 , MD_PDN, FUNC1); 	// P2.0 : UART0_TXD
	scu_pinmux(0x2 ,1 , MD_PDN, FUNC1); 	// P2.1 : UART0_RXD
	/*
	 * Initialize UART0 pin connect
	 */
	// DIR0 - P6_2
