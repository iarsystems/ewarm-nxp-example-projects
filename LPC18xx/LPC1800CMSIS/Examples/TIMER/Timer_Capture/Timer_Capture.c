/**********************************************************************
* $Id: Timer_Capture.c 28 2014-01-27 14:45:13Z danielru $		Timer_Capture.c			2011-06-02
*//**
...
void TIMER1_IRQHandler(void)
{
	if (TIM_GetIntCaptureStatus(LPC_TIMER1,(TIM_INT_TYPE)0))
	{
		TIM_ClearIntCapturePending(LPC_TIMER1,(TIM_INT_TYPE)0);
		_DBG("Time capture: ");
		_DBH32(TIM_GetCaptureValue(LPC_TIMER1,(TIM_COUNTER_INPUT_OPT)0));_DBG_("");
	}
}
