/**********************************************************************
* $Id: I2s_Audio.c 28 2014-01-27 14:45:13Z danielru $		I2s_Audio.c					2011-06-02
*//**
* @file		I2s_Audio.c
* @brief	This example describes how to use I2S to play a short demo
*			audio data on LPC178x
* @version	1.0
* @date		02. June. 2011
...
BOOL_32 UDA1380_init(){
  ...
  LPC_CGU->OUTCLK_20_CTRL = 0x0D<<24 | (1<<11);
  LPC_SCU->SFSCLK_3 = 1 | (0x3<<2);
...
/* Initialize I2S peripheral ------------------------------------*/
	...
	UDA1380_init();
/* Initialize I2S peripheral ------------------------------------*/
	scu_pinmux(3,0, MD_PDN, 2);
	scu_pinmux(6,0, MD_PDN, 0);

	scu_pinmux(7,2, MD_PDN, 2);
	scu_pinmux(6,2, MD_PDN, 3);

	scu_pinmux(7,1, MD_PDN, 2);
	scu_pinmux(6,1, MD_PDN, 3);
