 ...
 *     to develop code for IAR-LPC-11U14-SK board. It shows basic use of I/O,
 ...
 *    =============
 *
 *      The example project is compatible with, on IAR-LPC-11U14-SK evaluation
 ...
 *       Description : port for IAR-LPC11U14-SK board
 *
 *
 *    $Revision: 28 $
 **************************************************************************/
