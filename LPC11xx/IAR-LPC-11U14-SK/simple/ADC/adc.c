/*****************************************************************************
 *   adc.c:  ADC C file for NXP LPC11uxx Family Microprocessors
 *
...
void ADCInit( uint32_t ADC_Clk )
{
  ...
  LPC_IOCON->TDI_PIO0_11  &= ~0x8F; /*  ADC I/O config */
  LPC_IOCON->TDI_PIO0_11  |= 0x02;  /* ADC IN0 */
  LPC_IOCON->TMS_PIO0_12  &= ~0x8F;	
  LPC_IOCON->TMS_PIO0_12  |= 0x02;  /* ADC IN1 */
  LPC_IOCON->TDO_PIO0_13  &= ~0x8F;	
  LPC_IOCON->TDO_PIO0_13  |= 0x02;  /* ADC IN2 */
  LPC_IOCON->TRST_PIO0_14 &= ~0x8F;	
  LPC_IOCON->TRST_PIO0_14 |= 0x02; /* ADC IN3 */
  LPC_IOCON->SWDIO_PIO0_15&= ~0x8F;	
  LPC_IOCON->SWDIO_PIO0_15|= 0x02;  /* ADC IN4 */
#endif
  LPC_IOCON->PIO0_16   &= ~0x8F; /* Clear bit7, change to analog mode. */	
  LPC_IOCON->PIO0_16   |= 0x01;  /* ADC IN5 */
  LPC_IOCON->PIO0_22   &= ~0x8F; /* Clear bit7, change to analog mode. */	
  LPC_IOCON->PIO0_22   |= 0x01;  /* ADC IN6 */
  LPC_IOCON->PIO0_23   &= ~0x8F; /* Clear bit7, change to analog mode. */	
