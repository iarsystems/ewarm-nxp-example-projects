...
static void Init_UART_PinMux(void)
{
	...
	/* UART signals on pins PIO0_19 (FUNC1, U0_TXD) and PIO1_17 (FUNC2, U0_RXD) */
	Chip_IOCON_PinMuxSet(LPC_IOCON, 0, 19, (IOCON_FUNC1 | IOCON_MODE_INACT | IOCON_DIGMODE_EN));
	Chip_IOCON_PinMuxSet(LPC_IOCON, 1, 17, (IOCON_FUNC2 | IOCON_MODE_INACT | IOCON_DIGMODE_EN));

#elif defined(BOARD_NXP_XPRESSO_11U68)
#warning "No UART setup defined"
