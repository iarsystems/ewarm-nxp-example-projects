...
static const uint8_t ledpins[MAXLEDS] = {5, 10, 2};
...
{
	return Chip_GPIO_GetPinState(LPC_GPIO, ledports[LEDNumber], ledpins[LEDNumber]);
}
...
static const uint8_t portButton[NUM_BUTTONS] = {0, 0, 0, 1, 0};
static const uint8_t pinButton[NUM_BUTTONS] = {22, 23, 7, 23, 16};
