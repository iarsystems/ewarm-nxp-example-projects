/****************************************************************************
 *   $Id: pmu.c 28 2014-01-27 14:45:13Z danielru $
...
void WAKEUP_IRQHandler(void)
{
  ...
  regVal = LPC_SYSCON->STARTERP0;
  if ( regVal != 0 )
  {
  LPC_SYSCON->STARTERP0 &= ~regVal;
  }
...
#if 1
   bitPattern[0] = 0x1<<4;    /* PIO1_4 enabled */
//  bitPattern[0] = 0x00000020;   /* PIO0_5 enabled */
//  bitPattern[1] = 0x00000004;   /* PIO1_2 enabled */
  eventPattern[0] = 0x0<<4;   /* PIO1_4 falling edge */
