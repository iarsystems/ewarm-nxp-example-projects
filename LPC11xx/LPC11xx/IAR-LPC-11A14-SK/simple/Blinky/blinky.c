 ...
 *   Project: NXP LPC11Axx Blinky example
 *
 *   Description:
...
extern volatile uint32_t timer16_0_counter[4];
extern volatile uint32_t timer16_1_counter[4];
