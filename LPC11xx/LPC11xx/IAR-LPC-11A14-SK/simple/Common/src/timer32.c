/****************************************************************************
 *   $Id: timer32.c 28 2014-01-27 14:45:13Z danielru $
...
void set_timer32_capture(uint8_t timer_num, uint8_t location )
{
  if ( timer_num == 0 )
  {
    ...
    if ( location == 0 )
    {
      LPC_IOCON->PIO0_11          &= ~0x07;
      LPC_IOCON->PIO0_11          |= 0x04;    /* Timer0_32 CAP0 */
      LPC_IOCON->PIO0_14          &= ~0x07;
      LPC_IOCON->PIO0_14          |= 0x03;    /* Timer0_32 CAP1 */
      LPC_IOCON->PIO0_15          &= ~0x07;
      LPC_IOCON->PIO0_15          |= 0x03;    /* Timer0_32 CAP2 */
    }
    else if ( location == 1 )
    {
      LPC_IOCON->PIO0_23          &= ~0x07;
      LPC_IOCON->PIO0_23          |= 0x03;    /* Timer0_32 CAP0 */
      LPC_IOCON->PIO0_29          &= ~0x07;
      LPC_IOCON->PIO0_29          |= 0x03;    /* Timer0_32 CAP1 */
      LPC_IOCON->PIO0_26          &= ~0x07;
      LPC_IOCON->PIO0_26          |= 0x04;    /* Timer0_32 CAP2 */
    }
    else if ( location == 2 )
    {
      LPC_IOCON->PIO0_28          &= ~0x07;
      LPC_IOCON->PIO0_28          |= 0x03;    /* Timer0_32 CAP0 */
    }
    else
    {
  ...
  else
  {
    ...
    if ( location == 0 )
    {
      LPC_IOCON->TMS_PIO0_7       &= ~0x07;   /*  Timer1_32 I/O config */
      LPC_IOCON->TMS_PIO0_7       |= 0x03;    /* Timer1_32 CAP0 */
      LPC_IOCON->PIO0_21          &= ~0x07;
      LPC_IOCON->PIO0_21          |= 0x03;    /* Timer1_32 CAP1 */
      LPC_IOCON->PIO0_22          &= ~0x07;
      LPC_IOCON->PIO0_22          |= 0x04;    /* Timer1_32 CAP2 */
    }
    else if ( location == 1 )
    {
      LPC_IOCON->PIO0_20          &= ~0x07;
      LPC_IOCON->PIO0_20          |= 0x03;    /* Timer1_32 CAP0 */
      LPC_IOCON->PIO1_5           &= ~0x07;
      LPC_IOCON->PIO1_5           |= 0x04;    /* Timer1_32 CAP1 */
      LPC_IOCON->PIO1_6           &= ~0x07;
      LPC_IOCON->PIO1_6           |= 0x04;    /* Timer1_32 CAP2 */
    }
    else if ( location == 2 )
    {
      LPC_IOCON->PIO1_4          &= ~0x07;
      LPC_IOCON->PIO1_4          |= 0x04;   /* Timer1_32 CAP0 */
    }
    else
    {
      while ( 1 );        /* Fatal location number error */
...
void set_timer32_match(uint8_t timer_num, uint8_t match_enable, uint8_t location)
{
  if ( timer_num == 0 )
  {
    if ( match_enable & 0x01 )
    {
      ...
      LPC_IOCON->PIO0_12           |= 0x03;   /* Timer0_32 MAT0 */
      }
      else if ( location == 1 )
      {
      LPC_IOCON->PIO0_30           &= ~0x07;
      LPC_IOCON->PIO0_30           |= 0x03;   /* Timer0_32 MAT0 */
      }
    }
    if ( match_enable & 0x02 )
    {
      ...
      LPC_IOCON->PIO0_13           |= 0x03;   /* Timer0_32 MAT1 */
      }
      else if ( location == 1 )
      {
      LPC_IOCON->PIO1_4            &= ~0x07;
      LPC_IOCON->PIO1_4            |= 0x03;   /* Timer0_32 MAT1 */
      }
    }
    if ( match_enable & 0x04 )
    {
      ...
      LPC_IOCON->PIO0_1            |= 0x03;   /* Timer0_32 MAT2 */
      }
      else if ( location == 1 )
      {
      LPC_IOCON->PIO1_5            &= ~0x07;
      LPC_IOCON->PIO1_5            |= 0x03;   /* Timer0_32 MAT2 */
      }
    }
    if ( match_enable & 0x08 )
    {
      if ( location == 0 )
      {
      LPC_IOCON->TDI_PIO0_6        &= ~0x07;
      LPC_IOCON->TDI_PIO0_6        |= 0x03;   /* Timer0_32 MAT3 */
      }
      else if ( location == 1 )
      {
      LPC_IOCON->PIO1_6            &= ~0x07;
      LPC_IOCON->PIO1_6            |= 0x03;   /* Timer0_32 MAT3 */
      }
    }
  }
  else if ( timer_num == 1 )
  {
    if ( match_enable & 0x01 )
    {
      if ( location == 0 )
      {
      LPC_IOCON->TDO_PIO0_8        &= ~0x07;
      LPC_IOCON->TDO_PIO0_8        |= 0x03;     /* Timer1_32 MAT0 */
      }
      else if ( location == 1 )
      {
      LPC_IOCON->PIO0_31           &= ~0x07;
      LPC_IOCON->PIO0_31           |= 0x03;     /* Timer1_32 MAT0 */
      }
      else if ( location == 2 )
      {
      LPC_IOCON->PIO1_8            &= ~0x07;
      LPC_IOCON->PIO1_8            |= 0x03;     /* Timer1_32 MAT0 */
      }
    }
    if ( match_enable & 0x02 )
    {
      ...
      LPC_IOCON->TRST_PIO0_9       |= 0x03;     /* Timer1_32 MAT1 */
      }
      else if ( location == 1 )
      {
      LPC_IOCON->PIO0_27           &= ~0x07;
      LPC_IOCON->PIO0_27           |= 0x03;     /* Timer1_32 MAT1 */
      }
      else if ( location == 2 )
      {
      LPC_IOCON->PIO1_7            &= ~0x07;
      LPC_IOCON->PIO1_7            |= 0x03;     /* Timer1_32 MAT1 */
      }
    }
    if ( match_enable & 0x04 )
    {
      ...
      LPC_IOCON->SWDIO_PIO0_10     |= 0x03;     /* Timer1_32 MAT2 */
#endif
      }
      else if ( location == 1 )
      {
      LPC_IOCON->PIO0_22           &= ~0x07;
      LPC_IOCON->PIO0_22           |= 0x03;     /* Timer1_32 MAT2 */
      }
      else if ( location == 2 )
      {
      LPC_IOCON->PIO1_9            &= ~0x07;
      LPC_IOCON->PIO1_9            |= 0x03;     /* Timer1_32 MAT2 */
      }
    }
    if ( match_enable & 0x08 )
    {
      ...
      {
      LPC_IOCON->PIO0_11           &= ~0x07;
      LPC_IOCON->PIO0_11           |= 0x03;     /* Timer1_32 MAT3 */
      }
      else if ( location == 1 )
      {
      LPC_IOCON->PIO1_0            &= ~0x07;
      LPC_IOCON->PIO1_0            |= 0x03;     /* Timer1_32 MAT3 */
      }
      else if ( location == 2 )
      {
      LPC_IOCON->PIO1_1            &= ~0x07;
      LPC_IOCON->PIO1_1            |= 0x03;     /* Timer1_32 MAT3 */
      }
    }
  }
  return;
...
void init_timer32(uint8_t timer_num, uint32_t TimerInterval)
{
  ...
  if ( timer_num == 0 )
  {
    ...
    /* Peripheral reset control to 32-bit timer 0, a "1" bring it out of reset. */
    LPC_SYSCON->PRESETCTRL |= (0x1<<7);
    LPC_CT32B0->MR0 = TimerInterval;
    LPC_CT32B0->MR1 = TimerInterval;
    LPC_CT32B0->MR2 = TimerInterval;
    LPC_CT32B0->MR3 = TimerInterval;
#if TIMER_MATCH
    for ( i = 0; i < 4; i++ )
    {
    ...
    LPC_CT32B0->CCR = (0x7<<0)|(0x7<<3)|(0x7<<6)|(0x7<<9);
#endif
    /* Interrupt and Reset on MR0, MR1. Mr2, and MR3 */
    LPC_CT32B0->MCR = (0x3<<0)|(0x3<<3)|(0x3<<6)|(0x3<<9);
  ...
  else if ( timer_num == 1 )
  {
    ...
    /* Peripheral reset control to 32-bit timer 1, a "1" bring it out of reset. */
    LPC_SYSCON->PRESETCTRL |= (0x1<<8);
    LPC_CT32B1->MR0 = TimerInterval;
    LPC_CT32B1->MR1 = TimerInterval;
    LPC_CT32B1->MR2 = TimerInterval;
    LPC_CT32B1->MR3 = TimerInterval;
#if TIMER_MATCH
    for ( i = 0; i < 4; i++ )
    {
    ...
    set_timer32_capture(timer_num, 0 );
    /* Capture 0 on rising edge, interrupt enable. */
    LPC_CT32B1->CCR = (0x7<<0)|(0x7<<3)|(0x7<<6)|(0x7<<9);
#endif
    /* Interrupt and Reset on MR0, MR1. Mr2, and MR3 */
    LPC_CT32B1->MCR = (0x3<<0)|(0x3<<3)|(0x3<<6)|(0x3<<9);
