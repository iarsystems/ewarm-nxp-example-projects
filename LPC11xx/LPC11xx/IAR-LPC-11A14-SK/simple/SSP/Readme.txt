...
and slave mode on the NXP LPC11Axx microcontroller. 
...
** Pin configuration:
( P0_16 to P0_23 are jumpered to LEDs on the board. These must be removed prior to using the SSP pins)
SSP0:
PIO0_22 MISO
PIO0_19 MOSI
PIO0_20 SCK
...
** ssp.c provides options to configure the SSP pins to other pins. Please check the source code.