...
int I2C_InitMaster (unsigned long BusSpeed)
{
  ...
  SYSAHBCLKCTRL_bit.I2C = 1;      // enable I2C clock
  ...
  I2SCLH = ((SYS_GetPCLK() / BusSpeed) / 2) + 1;
  I2SCLL =  (SYS_GetPCLK() / BusSpeed) / 2;
  ...
  // Assign pins to SCL and SDA (P0_2, P0_3)
  IOCON_P0_2_bit.FUNC = 1;
  IOCON_P0_3_bit.FUNC = 1;
...
{
unsigned long I2Cstatus = I2STAT & 0xF8;
