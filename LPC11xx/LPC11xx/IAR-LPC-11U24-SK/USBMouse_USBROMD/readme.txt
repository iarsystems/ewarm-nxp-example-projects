...
===========
 ...
 to develop code for IAR-LPC11U24-SK board. It implements USB HID mouse using
 on-chip USB drivers.
  The USER and WAKE-UP button control horizontal movement and the AN_TRIM 
