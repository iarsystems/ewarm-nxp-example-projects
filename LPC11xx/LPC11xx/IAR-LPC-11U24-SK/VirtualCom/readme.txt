...
===========
 ...
 for ARM to develop code for the IAR LPC11U24-SK board.
...
=============
  ...
  The USB CDC application is downloaded to the iFlash.
...
===============
  ...
  2) Connect a serial cable between a Host COM port and the IAR LPC-11U24-SK
     UART connector and start a terminal emulator program on the Host.
     Configure the PC COM port are same like settings of the Virual COM port.
