...
===========
  ...
  timer, UART, I2C, on-board accelerometer sensor, and interrupt controller.
   It shows small pseudo-graphic square at the text-LCD display. When the
  board is tilted around X and Y axes, the square moves. Accelerometer info
  is printed to UART at application startup.
