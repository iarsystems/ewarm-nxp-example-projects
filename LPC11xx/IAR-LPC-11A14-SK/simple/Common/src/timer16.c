/****************************************************************************
 *   $Id: timer16.c 28 2014-01-27 14:45:13Z danielru $
...
void set_timer16_capture(uint8_t timer_num, uint8_t location )
{
  if ( timer_num == 0 )
  {
    ...
    if ( location == 0 )
    {
      ...
      LPC_IOCON->PIO0_2            |= 0x04;   /* Timer0_16 CAP0 */
      LPC_IOCON->PIO0_16           &= ~0x07;
      LPC_IOCON->PIO0_16           |= 0x03;   /* Timer0_16 CAP1 */
      LPC_IOCON->PIO0_17           &= ~0x07;
      LPC_IOCON->PIO0_17           |= 0x03;   /* Timer0_16 CAP2 */
    }
    else if ( location == 1 )
    {
      LPC_IOCON->PIO0_18           &= ~0x07;
      LPC_IOCON->PIO0_18           |= 0x03;   /* Timer0_16 CAP0 */
      LPC_IOCON->PIO1_4            &= ~0x07;
      LPC_IOCON->PIO1_4            |= 0x05;   /* Timer0_16 CAP1 */
      LPC_IOCON->PIO1_5            &= ~0x07;
      LPC_IOCON->PIO1_5            |= 0x05;   /* Timer0_16 CAP2 */
    }
    else if ( location == 2 )
    {
      LPC_IOCON->PIO0_30           &= ~0x07;
      LPC_IOCON->PIO0_30           |= 0x04;   /* Timer0_16 CAP0 */
    }
  }
  else
  {
    ...
    if ( location == 0 )
    {
      LPC_IOCON->PIO0_3           &= ~0x07;   /*  Timer1_16 I/O config */
      LPC_IOCON->PIO0_3           |= 0x04;    /* Timer1_16 CAP0 */
      LPC_IOCON->PIO0_18          &= ~0x07;
      LPC_IOCON->PIO0_18          |= 0x04;    /* Timer1_16 CAP1 */
      LPC_IOCON->PIO0_27          &= ~0x07;
      LPC_IOCON->PIO0_27          |= 0x04;    /* Timer1_16 CAP2 */
    }
    else if ( location == 1 )
    {
      LPC_IOCON->PIO0_24           &= ~0x07;  /*  Timer1_16 I/O config */
      LPC_IOCON->PIO0_24           |= 0x03;   /* Timer1_16 CAP0 */
      LPC_IOCON->PIO0_26           &= ~0x07;
      LPC_IOCON->PIO0_26           |= 0x03;   /* Timer1_16 CAP1 */
      LPC_IOCON->PIO1_7            &= ~0x07;
      LPC_IOCON->PIO1_7            |= 0x05;   /* Timer1_16 CAP2 */
    }
    else if ( location == 2 )
    {
      LPC_IOCON->PIO1_3           &= ~0x07;   /*  Timer1_16 I/O config */
      LPC_IOCON->PIO1_3           |= 0x03;    /* Timer1_16 CAP0 */
      LPC_IOCON->PIO0_31          &= ~0x07;
      LPC_IOCON->PIO0_31          |= 0x04;    /* Timer1_16 CAP1 */
    }
  }
  return;
}
...
void set_timer16_match(uint8_t timer_num, uint8_t match_enable, uint8_t location)
{
  if ( timer_num == 0 )
  {
    if ( match_enable & 0x01 )
    {
      ...
      if ( location == 0 )
      {
      LPC_IOCON->TMS_PIO0_7       &= ~0x07;
      LPC_IOCON->TMS_PIO0_7       |= 0x04;    /* Timer0_16 MAT0 */
      }
      else if ( location == 1 )
      {
      LPC_IOCON->PIO0_17          &= ~0x07;
      LPC_IOCON->PIO0_17          |= 0x04;    /* Timer0_16 MAT0 */
      }
      else if ( location == 2 )
      {
      LPC_IOCON->PIO1_6           &= ~0x07;
      LPC_IOCON->PIO1_6           |= 0x05;    /* Timer0_16 MAT0 */
      }
    }
    if ( match_enable & 0x02 )
    {
      ...
      LPC_IOCON->PIO0_4           |= 0x03;    /* Timer0_16 MAT1 */
      }
      else if ( location == 1 )
      {
      LPC_IOCON->TRST_PIO0_9      &= ~0x07;
      LPC_IOCON->TRST_PIO0_9      |= 0x04;    /* Timer0_16 MAT1 */
      }
      else if ( location == 2 )
      {
      LPC_IOCON->PIO1_0           &= ~0x07;
      LPC_IOCON->PIO1_0           |= 0x04;    /* Timer0_16 MAT1 */
      }
    }
    if ( match_enable & 0x04 )
    {
      ...
      LPC_IOCON->SWCLK_PIO0_5      &= ~0x07;
      LPC_IOCON->SWCLK_PIO0_5      |= 0x03;   /* Timer0_16 MAT2 */
#endif
      }
      else if ( location == 1 )
      {
#ifdef __SWD_DISABLED
      LPC_IOCON->SWDIO_PIO0_10     &= ~0x07;
      LPC_IOCON->SWDIO_PIO0_10     |= 0x04;   /* Timer0_16 MAT2 */
#endif
      }
      else if ( location == 2 )
      {
      LPC_IOCON->PIO1_7            &= ~0x07;
      LPC_IOCON->PIO1_7            |= 0x04;   /* Timer0_16 MAT2 */
      }
    }
  }
  else if ( timer_num == 1 )
  {
    if ( match_enable & 0x01 )
    {
      ...
      LPC_IOCON->PIO0_19           |= 0x04;   /* Timer1_16 MAT0 */
      }
      else if ( location == 1 )
      {
      LPC_IOCON->PIO0_25           &= ~0x07;
      LPC_IOCON->PIO0_25           |= 0x03;   /* Timer1_16 MAT0 */
      }
      else if ( location == 2 )
      {
      LPC_IOCON->PIO1_1            &= ~0x07;
      LPC_IOCON->PIO1_1            |= 0x04;   /* Timer1_16 MAT0 */
      }
    }
    if ( match_enable & 0x02 )
    {
      ...
      LPC_IOCON->PIO0_14           |= 0x04;   /* Timer1_16 MAT1 */
      }
      else if ( location == 1 )
      {
      LPC_IOCON->PIO1_2            &= ~0x07;
      LPC_IOCON->PIO1_2            |= 0x04;   /* Timer1_16 MAT1 */
      }
      else if ( location == 2 )
      {
      LPC_IOCON->PIO1_8            &= ~0x07;
      LPC_IOCON->PIO1_8            |= 0x04;   /* Timer1_16 MAT1 */
      }
    }
    if ( match_enable & 0x04 )
    {
      ...
      LPC_IOCON->PIO0_20           |= 0x04;   /* Timer1_16 MAT2 */
      }
      else if ( location == 1 )
      {
      LPC_IOCON->PIO1_2            &= ~0x07;
      LPC_IOCON->PIO1_2            |= 0x03;   /* Timer1_16 MAT2 */
      }
      else if ( location == 2 )
      {
      LPC_IOCON->PIO1_9            &= ~0x07;
      LPC_IOCON->PIO1_9            |= 0x04;   /* Timer1_16 MAT2 */
      }
    }
  }
  return;
...
void init_timer16(uint8_t timer_num, uint32_t TimerInterval)
{
  ...
  if ( timer_num == 0 )
  {
    ...
    /* Peripheral reset control to TIMER16 0, a "1" bring it out of reset. */
    LPC_SYSCON->PRESETCTRL |= (0x1<<5);
    LPC_CT16B0->MR0 = TimerInterval;
    LPC_CT16B0->MR1 = TimerInterval;
    LPC_CT16B0->MR2 = TimerInterval;
    LPC_CT16B0->MR3 = TimerInterval;
#if TIMER_MATCH
    for ( i = 0; i < 4; i++ )
    {
    ...
    LPC_CT16B0->EMR |= ((0x3<<4)|(0x3<<6)|(0x3<<8)|(0x3<<10));
#else
    for ( i = 0; i < 4; i++ )
    {
    ...
    LPC_CT16B0->CCR = (0x5<<0)|(0x5<<3)|(0x5<<6)|(0x5<<9);
#endif
  /* Interrupt and Reset on MR0, MR1. Mr2, and MR3 */
    LPC_CT16B0->MCR = (0x3<<0)|(0x3<<3)|(0x3<<6)|(0x3<<9);
  ...
  /* Peripheral reset control to TIMER16 1, a "1" bring it out of reset. */
    LPC_SYSCON->PRESETCTRL |= (0x1<<6);
    LPC_CT16B1->MR0 = TimerInterval;
    LPC_CT16B1->MR1 = TimerInterval;
    LPC_CT16B1->MR2 = TimerInterval;
    LPC_CT16B1->MR3 = TimerInterval;
#if TIMER_MATCH
    for ( i = 0; i < 4; i++ )
    {
    ...
    LPC_CT16B1->EMR |= ((0x3<<4)|(0x3<<6)|(0x3<<8)|(0x3<<10));
#else
    for ( i = 0; i < 4; i++ )
    {
    ...
    set_timer16_capture(timer_num, 0);
    /* Capture 0 and 1 on rising edge, interrupt enable. */
    LPC_CT16B1->CCR = (0x5<<0)|(0x5<<3)|(0x5<<6)|(0x5<<9);
#endif
  /* Interrupt and Reset on MR0, MR1. Mr2, and MR3 */
    LPC_CT16B1->MCR = (0x3<<0)|(0x3<<3)|(0x3<<6)|(0x3<<9);
