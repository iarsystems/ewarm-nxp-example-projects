/****************************************************************************
 *   $Id: clkconfig.h 28 2014-01-27 14:45:13Z danielru $
...
#define SYSPLL_SRC_CLK_IN           2

#define MAINCLK_SRC_IRC_OSC         0
#define MAINCLK_SRC_SYS_OSC         1
#define MAINCLK_SRC_LFO_OSC         2
#define MAINCLK_SRC_SYS_PLL         3

#define WDTCLK_SRC_IRC_OSC          0
#define WDTCLK_SRC_WDT_OSC          1

#define CLKOUTCLK_SRC_IRC_OSC       0  /* Name change, IRC in LPC11Axx */
#define CLKOUTCLK_SRC_SYS_OSC       1
#define CLKOUTCLK_SRC_LFO_OSC       2  /* Name change, LFO in LPC11Axx. */
