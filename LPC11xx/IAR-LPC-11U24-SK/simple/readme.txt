...
Description of the Example software
===================
...
timer routine. The peripheral directories include, ADC, GPIO, timer, SSP, I2C,
Watchdog timer, eepromAPI, UART, external interrupt, various USB class drivers,etc.

Some external components, such as I2C temperature, SPI serial EEPROM, will be
required to add on the board in order to complete the corresponding tests.
...
8.  timer32
9.  UART
10. USBROMD\ROM_USB_cdc
11. USBROMD\ROM_USB_hid
12. USBROMD\ROM_USB_msc
13. wdt
