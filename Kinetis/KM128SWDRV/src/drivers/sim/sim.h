...
#define SIM_SelAdcTrgClk(src)                                                 \
                    iobfiw (SIM_CTRL_REG,SIM_CTRL_REG_SAR_TRG_CLK_SEL_SHIFT,2,src)
...
#define SIMCH0_SelTmrScs(src)                                                 \
                      iobfiw (SIM_MISC_CTL,SIM_MISC_CTL_TMR0SCSSEL_SHIFT,1,src)
#define SIMCH1_SelTmrScs(src)                                                 \
                      iobfiw (SIM_MISC_CTL,SIM_MISC_CTL_TMR1SCSSEL_SHIFT,1,src)
#define SIMCH2_SelTmrScs(src)                                                 \
                      iobfiw (SIM_MISC_CTL,SIM_MISC_CTL_TMR2SCSSEL_SHIFT,1,src)
#define SIMCH3_SelTmrScs(src)                                                 \
                      iobfiw (SIM_MISC_CTL,SIM_MISC_CTL_TMR3SCSSEL_SHIFT,1,src)
/***************************************************************************//*!
