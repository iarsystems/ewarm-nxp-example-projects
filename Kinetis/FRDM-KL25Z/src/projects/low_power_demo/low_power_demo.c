...
#if 0
        Port_Init(1);  // 1 - sets the Port interrupt, 0 - sets the NMI interrupt
#endif
        SW_LED_Init();
        EnableInterrupts;
        /*Start test*/
	...
	while(1)
	{
            ...
            while (test_num > 22 | test_num < 0){
               if ((SMC_PMSTAT & SMC_PMSTAT_PMSTAT_MASK)== 4){
                ...
                printf("A for CASE 10: Enter WAIT\n");
                printf("B for CASE 11: Enter Normal STOP\n");
            ...
            switch(test_num){
              ...
              case 0://VLLS0 no POR
                ...
                printf("Press SW3 to wake up from VLLS0\n ");
                clockMonitor(OFF);
                set_4_lp(0);
                enter_vlls0(1);
                break;
             ...
             case 1://VLLS0
                ...
                uart0_getchar(UART0_BASE_PTR);
                printf("\nPress SW3 to wake up from VLLS0\n ");
                clockMonitor(OFF);
                set_4_lp(0);
                enter_vlls0(0);
                break;
              ...
              case 2://VLLS1
                ...
                uart0_getchar(UART0_BASE_PTR);
                printf("Press SW3 to wake up from VLLS1\n ");
                clockMonitor(OFF);
                set_4_lp(0);
                enter_vlls1();
                break;
              ...
              case 3://LLS loop wake up every 100 ms
                ...
                llwu_configure(0x0000, LLWU_PIN_FALLING, 0x1);
                    ...
                    printf("Press SW3 to wake up from VLLS2\n ");
                for (i=0;i<10;i++)
                  {
              ...
              case 4://VLLS3
                ...
                uart0_getchar(UART0_BASE_PTR);
                printf("Press SW3 to wake up from VLLS3\n ");
                clockMonitor(OFF);
                // UART(OFF);
                enter_vlls3();
                break;
              ...
              case 5://LLS
                ...
                uart0_getchar(UART0_BASE_PTR);
                printf("Press SW3 to wake up from LLS\n ");
                clockMonitor(OFF);
                set_4_lp(0);
                enter_lls();
                set_4_lp(1);
              ...
              case 6://VLPS
                ...
                uart0_getchar(UART0_BASE_PTR);
                printf("Press SW2 to wake up from VLPS\n ");
                clockMonitor(OFF);
                /*Go to VLPS*/
             ...
             case 9:// VLPW
              ...
              case 0xa://WAIT
                ...
                uart0_getchar(UART0_BASE_PTR);
                  printf("Press SW2 to wake up from Wait\n ");
                clockMonitor(OFF);
                /*Enter wait mode*/
                enter_wait();
                if ((SMC_PMSTAT & SMC_PMSTAT_PMSTAT_MASK)== 4){
              ...
              case 0xb://STOP
                ...
                uart0_getchar(UART0_BASE_PTR);
                  printf("Press SW2 to wake up from Normal Stop\n ");
                clockMonitor(OFF);
                /*Enter stop mode*/
              ...
              case 0xc://PSTOP1
                ...
                uart0_getchar(UART0_BASE_PTR);
                  printf("Press SW2 to wake up from Stop PSTOP1 \n ");
                clockMonitor(OFF);
                /*Enter stop mode
                * Partial Stop Option:
            ...
            case 0xd://STOP PSTOP2
                ...
                uart0_getchar(UART0_BASE_PTR);
                  printf("Press SW2 to wake up from Stop PSTOP2\n ");
                clockMonitor(OFF);
                /*Enter stop mode
                * Partial Stop Option:
                *  0x00 = STOP - Normal Stop Mode
...
void Port_Init(int io_nmi){
 ...
 // time delay to ensure PCR register Write is complete
  ...
  if (buttons_read == 0x8) {  // SW3 buttons not -pressed
    ...
    printf("\n*-------Press SW3 then press Reset to re-enable debug---------*");
    } else {
    printf("\n*--------------D E B U G    E N A B L E D--------------------*");
...
void set_4_lp(unsigned char outof_lp)
{
    ...
    }else  // enter low power - turn things off
    {
      if (TERM_PORT_NUM == 0){
 ...
 *
 * input: next_mode = BLPI or BLPE or .....
 *****************************************************************/
void vlp_clock_config(char next_mode)
{
  ...
  if ((SMC_PMSTAT & SMC_PMSTAT_PMSTAT_MASK)== 4){
       printf("\nIn VLPR Mode ! Must go to RUN to change Clock Modes --> ");
       exit_vlpr();
  }
  if ((SMC_PMSTAT & SMC_PMSTAT_PMSTAT_MASK)== 1)
      printf("In RUN Mode !\n");
