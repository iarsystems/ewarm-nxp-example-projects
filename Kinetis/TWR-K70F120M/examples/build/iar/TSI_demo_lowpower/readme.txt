...
DESCRIPTION
===========
   This project demonstrates basic usage of the Touch Sense Interface
  module. It toggles the LEDs on the tower board by pressing the touch
  pads. Also demonstrates the low power modes of the cpu.
