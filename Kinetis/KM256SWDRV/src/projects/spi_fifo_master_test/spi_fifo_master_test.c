...
void main (void)
{
  ...
  PORT_Init (PORTD, PORT_MODULE_BUTTON_IRQ_MODE, PIN1);
  GPIO_Init (GPIOD, GPIO_INP_MODE, PIN1);
  ...
  SPI_Init (SPI1, SPI_MODULE_DIV6_16B_FIFO_MASTER_CPHA_CONFIG, NULL);
