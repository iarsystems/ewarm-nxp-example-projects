 ...
 * - hi speed mode,
 * - IRQ will be generated on rising and falling edge if interrupt callback
 *   is installed using @ref CMP_InstallCallback function,
 * - DAC enable
 * @param   dac       DAC output voltage select from 0 to 63.
 * @showinitializer
 ******************************************************************************/
#define CMP_MODULE_EN_FILTER7_SAMPLE_PER_255_DAC_EN_CONFIG_BOTH_EDGES(dac)    \
(tCMP){                                                                       \
