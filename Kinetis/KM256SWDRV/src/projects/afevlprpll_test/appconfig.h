 ...
 *          by Micro Trace Buffer (MTB). The trace buffer starts at 0x1fffe000
...
/* CTRL_REG */ CLR(SIM_CTRL_REG_TMRFREEZE_MASK)|                                \
/* ........ */ CLR(SIM_CTRL_REG_PDBCLKSRC_MASK)|SET(SIM_CTRL_REG_LPUARTSRC(1))| \
...
/* ........ */ SET(SIM_CTRL_REG_PLLVLPEN_MASK)|SET(SIM_CTRL_REG_NMIDIS_MASK),   \
/* SCGC4    */ CLR(SIM_SCGC4_SPI1_MASK)|CLR(SIM_SCGC4_SPI0_MASK)|               \
/* ........ */ CLR(SIM_SCGC4_CMP_MASK)|SET(SIM_SCGC4_VREF_MASK)|                \
/* ........ */ CLR(SIM_SCGC4_UART3_MASK)|CLR(SIM_SCGC4_UART2_MASK)|             \
/* ........ */ SET(SIM_SCGC4_UART1_MASK)|CLR(SIM_SCGC4_UART0_MASK)|             \
...
/* ........ */ SET(SIM_SCGC5_PORTI_MASK)|CLR(SIM_SCGC5_PORTH_MASK)|             \
...
/* ........ */ CLR(SIM_SCGC6_CRC_MASK)|SET(SIM_SCGC6_AFE_MASK)|                 \
