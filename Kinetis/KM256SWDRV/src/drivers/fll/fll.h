...
#define __FLL_H
  ...
  #error "The fll.h module is specific to the MKM34Z256VLx7 microcontrollers."
#endif
...
/***************************************************************************//*!
 * @brief   FLL Engaged External (DCO Range: 72 MHz). FLL clocked by 32 KHz RTC
 *          Oscillator Clock Source (32.768KHz external crystal).
 * @details FLL Engaged External (DCO Range: 72 MHz). FLL clocked by 32 KHz RTC
 *          Oscillator Clock Source (32.768KHz external crystal). Use @ref
 *          SIM_SetClkDiv and @ref SIM_SetClkMode to divide core and bus clocks
 *          to allowed ranges.
 * @showinitializer
 ******************************************************************************/
...
/***************************************************************************//*!
 * @brief   FLL Engaged External (DCO Range: 60 - 75 MHz). Clocked by System
 *          Oscillator Clock with Frequency Range 8.0 - 10.0 MHz.
 * @details FLL Engaged External (DCO Range: 60 - 75 MHz). Clocked by System
 *          Oscillator Clock with Frequency Range 8.0 - 10.0 MHz. Use @ref
 *          SIM_SetClkDiv and @ref SIM_SetClkMode to divide core and bus clocks
 *          to allowed ranges.
 * @showinitializer
 ******************************************************************************/
