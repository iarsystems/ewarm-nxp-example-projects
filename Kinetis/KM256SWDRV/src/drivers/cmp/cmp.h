...
#define __CMP_H
  ...
  #error "The cmp.h module is specific to the MKM34Z256VLx7 microcontrollers."
#endif
...
typedef enum
{
  ...
  CMP2_CALLBACK = 3           ///< passed to notify CMP2 interrupt request
} CMP_CALLBACK_SRC;
...
/***************************************************************************//*!
 * @brief   Installs callback function for CMP0, CMP1 and CMP2 interrupt
 *          vector 30.
 * @details This function installs callback function for CMP0, CMP1 and CMP2
 *          interrupt vector 30.
 ...
 * @warning CMP0, CMP1 and CMP2 interrupt sources are OR'ed into single
 *          interrupt vector.
 * @see     @ref CMP_Init
 ******************************************************************************/
...
extern void CMP2_Init (tCMP cmp, uint8 psel, uint8 msel);
