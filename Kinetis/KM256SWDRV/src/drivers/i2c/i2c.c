...
#include "i2c.h"
  ...
  #error "The i2c.c module is specific to the MKM34Z256VLx7 microcontrollers."
#endif
...
weak void i2cx_isr (void)
{
  ...
  {
    /* Stop detect flag testing                                               */
    if (I2C_GetStopfFlag(I2C0)) { I2C_ClrStopfFlag(I2C0); }

    /* Start detect flag testing                                              */
    if (I2C_GetStartfFlag(I2C0)) { I2C_ClrStartfFlag(I2C0); }
  ...
  {
    /* Stop detect flag testing                                               */
    if (I2C_GetStopfFlag(I2C1)) { I2C_ClrStopfFlag(I2C1); }

    /* Start detect flag testing                                              */
    if (I2C_GetStartfFlag(I2C1)) { I2C_ClrStartfFlag(I2C1); }
