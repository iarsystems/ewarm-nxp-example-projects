...
#define __UART_H
  ...
  #error "The uart.h module is specific to the MKM34Z256VLx7 microcontrollers."
#endif
...
{                                                                             \
  ...
  {                                                                           \
    ...
    buffer[__tmp++]=module##_D;     /* read and store new byte            */  \
  }                                                                           \
}
...
{                                                                             \
  ...
  {                                                                           \
    ...
    module##_D = buffer[__tmp++];   /* write new byte                     */  \
  }                                                                           \
...
/***************************************************************************//*!
 * @brief   Installs callback function for UART interrupt vector 35.
 * @details This function installs callback function for UART interrupt vector 35.
 ...
 * @see     @ref UART_Init
 ******************************************************************************/
#define UART_InstallCallback(ip,callback) UART_InstallCallback(ip,callback)
 ...
 ******************************************************************************/
extern void UART_InstallCallback (uint8 ip, UART_CALLBACK pCallback);
