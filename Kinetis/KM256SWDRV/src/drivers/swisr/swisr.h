...
#define __SWISR_H
  ...
  #error "The swisr.h module is specific to the MKM34Z256VLx7 microcontrollers."
#endif
...
#define SWISR_VECTOR_1  INT_WDOG_EWM  ///< SWISR driver handler 1 assigned to INT_WDOG_EWM
