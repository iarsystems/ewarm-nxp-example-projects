...
#define __SPI_H
  ...
  #error "The spi.h module is specific to the MKM34Z256VLx7 microcontrollers."
#endif
...
/***************************************************************************//*!
 * @brief   Installs callback function for SPI interrupt vector 20.
 * @details This function installs callback function for SPI interrupt vector 20.
 * @param   ip        Select one of the @ref cm0plus_prilvl.
 * @param   callback  Pointer to the @ref spi_callback.
 * @note    Implemented as a function call.
 * @see     @ref SPI_Init
 ******************************************************************************/
#define SPI_InstallCallback(ip,callback)  SPI_InstallCallback(ip,callback)

/***************************************************************************//*!
 * @brief   SPI initialization.
 * @details This macro initializes selected SPI module.
 * @param   module  SPI0,SPI1
 * @param   cfg     Select one of @ref spi_config.
 * @param   call2   Pointer to @ref spi_ss_callback where SS pin is manually
 *                  driven.
 * @note    Implemented as a function call.
 * @see     @ref SPI_InstallCallback
 ******************************************************************************/
#define SPI_Init(module,cfg,call2)   module##_Init(cfg,call2)
/*! @} End of spi_macro                                                       */

/******************************************************************************
 * public function prototypes                                                 *
 ******************************************************************************/
extern void SPI_InstallCallback (uint8 ip, SPI_CALLBACK pCallback);
extern void SPI0_Init (tSPI spi,SPI_SSCALLBACK pC2);
extern void SPI1_Init (tSPI spi,SPI_SSCALLBACK pC2);
