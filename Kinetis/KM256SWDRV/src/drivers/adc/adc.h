...
#define __ADC_H
  ...
  #error "The adc.h module is specific to the MKM34Z256VLx7 microcontrollers."
#endif
...
* @{
*******************************************************************************/
#define ADC_SE0       (uint8)0   ///< Single ended input from pin
#define ADC_SE1       (uint8)1   ///< Single ended input from pin
#define ADC_SE2       (uint8)2   ///< Single ended input from pin
#define ADC_SE3       (uint8)3   ///< Single ended input from pin
#define ADC_SE4       (uint8)4   ///< Single ended input from pin
#define ADC_SE5       (uint8)5   ///< Single ended input from pin
#define ADC_SE6       (uint8)6   ///< Single ended input from pin
#define ADC_SE7       (uint8)7   ///< Single ended input from pin
#define ADC_SE8       (uint8)8   ///< Single ended input from pin
#define ADC_SE9       (uint8)9   ///< Single ended input from pin
#define ADC_SE10      (uint8)10  ///< Single ended input from pin
#define ADC_SE11      (uint8)11  ///< Single ended input from pin
#define ADC_SE12      (uint8)12  ///< Single ended input from pin
#define ADC_SE13      (uint8)13  ///< Single ended input from pin
#define ADC_SE14      (uint8)14  ///< Single ended input from pin
#define ADC_SE15      (uint8)15  ///< Single ended input from pin
#define PMC_VDD       (uint8)17  ///< VDD supply from PMC
#define PMC_VDD_SW    (uint8)18  ///< Switched VDD supply from PMC
#define SAR_VDDA      (uint8)19  ///< VDDA supply for SAR
#define CMP0_DAC_OUT  (uint8)20  ///< CMP0 DAC output voltage
#define CMP1_DAC_OUT  (uint8)21  ///< CMP1 DAC output voltage
#define CMP2_DAC_OUT  (uint8)22  ///< CMP2 DAC output voltage
#define VBAT          (uint8)23  ///< VBAT input voltage from VBAT pin
#define SENSE_BUS     (uint8)24  ///< Sense bus(for test)
#define TEMP_SENSOR   (uint8)26  ///< Temperature Sensor
#define PMC_1V_BG_OUT (uint8)27  ///< PMC 1V Bandgap
#define VREFH         (uint8)29  ///< VREFH
#define VREFL         (uint8)30  ///< VREFL
#define AD_OFF        (uint8)31  ///< Module Disabled
/*! @} End of adc_chan_muxa                                                   */

/******************************************************************************
* ADC input channels selected by ADC_CFG2_MUXSEL = 1 (MUXB).
*
*//*! @addtogroup adc_chan_muxb
* @{
*******************************************************************************/
#define VLL1          (uint8)4   ///< LCD VLL1 Voltage
#define VCAP1         (uint8)5   ///< LCD VCAP1 Voltage
#define VCAP2         (uint8)6   ///< LCD VCAP2 Voltage
#define VLL2          (uint8)7   ///< LCD VLL2 Voltage
/*! @} End of adc_chan_muxb                                                   */
 ...
 * @brief Selects 16-bit software triggered mode with internal voltage reference.
 * @details Selects 16-bit software triggered mode with internal voltage
 * reference. It initializes ADC module to convert @ref adc_chan_muxb.
 * @showinitializer
 ******************************************************************************/
#define ADC_MODULE_16B_SWTRG_IREF_MUXB_CONFIG                                 \
(tADC){                                                                       \
/* CFG1   */  CLR(ADC_CFG1_ADLPC_MASK)|SET(ADC_CFG1_ADIV(3))|                 \
/* ....   */  SET(ADC_CFG1_ADLSMP_MASK)|SET(ADC_CFG1_MODE(3))|                \
/* ....   */  SET(ADC_CFG1_ADICLK(0)),                                        \
 ...
 * @showinitializer
 ******************************************************************************/
#define ADC_MODULE_16B_SWTRG_XREF_MUXB_CONFIG                                 \
(tADC){                                                                       \
/* CFG1   */  CLR(ADC_CFG1_ADLPC_MASK)|SET(ADC_CFG1_ADIV(3))|                 \
/* ....   */  SET(ADC_CFG1_ADLSMP_MASK)|SET(ADC_CFG1_MODE(3))|                \
/* ....   */  SET(ADC_CFG1_ADICLK(0)),                                        \
 ...
 * @showinitializer
 ******************************************************************************/
#define ADC_MODULE_16B_HWTRG_IREF_MUXB_CONFIG                                 \
(tADC){                                                                       \
/* CFG1   */  CLR(ADC_CFG1_ADLPC_MASK)|SET(ADC_CFG1_ADIV(3))|                 \
/* ....   */  SET(ADC_CFG1_ADLSMP_MASK)|SET(ADC_CFG1_MODE(3))|                \
/* ....   */  SET(ADC_CFG1_ADICLK(0)),                                        \
 ...
 * @showinitializer
 ******************************************************************************/
#define ADC_MODULE_16B_HWTRG_XREF_MUXB_CONFIG                                 \
(tADC){                                                                       \
/* CFG1   */  CLR(ADC_CFG1_ADLPC_MASK)|SET(ADC_CFG1_ADIV(3))|                 \
/* ....   */  SET(ADC_CFG1_ADLSMP_MASK)|SET(ADC_CFG1_MODE(3))|                \
/* ....   */  SET(ADC_CFG1_ADICLK(0)),                                        \
 ...
 * @param   ch        Select one of the @ref adc_chan_muxa or @ref adc_chan_muxb.
 * @showinitializer
 ******************************************************************************/
...
* @{
*******************************************************************************/
#define ADC_CHA_Start(inp)      iobfiw(ADC0_SC1A,ADC_SC1_ADCH_SHIFT,5,inp)
/***************************************************************************//*!
 ...
 * @param   ch        CHA.
 * @param   inp       Select one of the @ref adc_chan_muxa or @ref adc_chan_muxb.
 * @note    Implemented as an inline macro.
 ******************************************************************************/
#define ADC_Start(ch,inp)       ADC_##ch##_Start(inp)

#define ADC_CHA_Ready           (ADC0_SC1A & ADC_SC1_COCO_MASK)
#define ADC_CHB_Ready           (ADC0_SC1B & ADC_SC1_COCO_MASK)
#define ADC_CHC_Ready           (ADC0_SC1C & ADC_SC1_COCO_MASK)
#define ADC_CHD_Ready           (ADC0_SC1D & ADC_SC1_COCO_MASK)
/***************************************************************************//*!
...
#define ADC_CHA_Read            (uint16)ADC0_RA
#define ADC_CHB_Read            (uint16)ADC0_RB
#define ADC_CHC_Read            (uint16)ADC0_RC
#define ADC_CHD_Read            (uint16)ADC0_RD
/***************************************************************************//*!
 * @brief   Returns value from the result register.
 * @details This macro returns value from the respective result register.
 * @param   ch        CHA,CHB,CHC,CHD.
 * @return  @ref uint16 right-justified value converted by the ADC. The number of
