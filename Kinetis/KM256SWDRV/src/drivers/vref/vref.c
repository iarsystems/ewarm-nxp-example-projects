...
#include "vref.h"
  ...
  #error "The vref.c module is specific to the MKM34Z256VLx7 microcontrollers."
#endif
...
void VREF_Init (tVREF vref, tVREF_S vref_s)
{
  ...
  tmpl           = (SIM_MISC_CTL & (                                           \
                                      ...
                                      SIM_MISC_CTL_TMR3SCSEL_MASK|             \
                                      SIM_MISC_CTL_TMR2SCSEL_MASK|             \
                                      SIM_MISC_CTL_TMR1SCSEL_MASK|             \
                                      SIM_MISC_CTL_TMR0SCSEL_MASK|             \
                                      SIM_MISC_CTL_TMR0PLLSEL_MASK|            \
