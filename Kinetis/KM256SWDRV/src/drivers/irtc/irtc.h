...
#define __IRTC_H
  ...
  #error "The irtc.h module is specific to the MKM34Z256VLx7 microcontrollers."
#endif

/******************************************************************************
 * Configuration structure definitions                                        *
 ******************************************************************************/
typedef struct { uint16 CTRL, COMPEN; } tIRTC;
typedef struct { uint16 FILTER_CFG;   } tTAMPER;
 ...
 * @showinitializer
 ******************************************************************************/
#define IRTC_MODULE_COMP_COARSE_CONFIG(interval,value)                        \
(tIRTC){                                                                      \
/* CTRL     */  CLR(RTC_CTRL_SWR_MASK)|CLR(RTC_CTRL_DST_EN_MASK)|             \
/* ....     */  CLR(RTC_CTRL_TIMER_STB_MASK_MASK)|                            \
/* ....     */  SET(RTC_CTRL_ALM_MATCH(0x00))|                                \
 ...
 * @showinitializer
 ******************************************************************************/
#define IRTC_MODULE_COMP_FINE_CONFIG(integer,fraction)                        \
(tIRTC){                                                                      \
/* CTRL     */  CLR(RTC_CTRL_SWR_MASK)|CLR(RTC_CTRL_DST_EN_MASK)|             \
/* ....     */  CLR(RTC_CTRL_TIMER_STB_MASK_MASK)|                            \
/* ....     */  SET(RTC_CTRL_ALM_MATCH(0x00))|                                \
 ...
 * @showinitializer
 ******************************************************************************/
#define IRTC_TAMPER_PIN_POL_HIGH_CONFIG(clksrc,period)                        \
(tTAMPER){                                                                    \
/*FILTER_CFG */ CLR(RTC_FILTER01_CFG_POL1_MASK)|                              \
 ...
 * @showinitializer
 ******************************************************************************/
#define IRTC_TAMPER_PIN_POL_LOW_CONFIG(clksrc,period)                         \
(tTAMPER){                                                                    \
