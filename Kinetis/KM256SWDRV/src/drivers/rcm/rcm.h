...
#define __RCM_H
  ...
  #error "The rcm.h module is specific to the MKM34Z256VLx7 microcontrollers."
#endif
...
/***************************************************************************//*!
 * @brief   Returns reset source type caused after last POR, LVD, or VLLS
 * @details This macro returns status flags indicating all reset sources since
 * the last POR, LVD or VLLS wakeup that have not been cleared by software.
 * @return  @ref rcm_rst_sources.
 * @note    Implemented as an inline macro.
 ******************************************************************************/
#define RCM_GetStickyResetSrc()   ((uint16)RCM_SSRS0|(((uint16)RCM_SSRS1)<<8))
...
/***************************************************************************//*!
 * @brief   Clears reset source status flags caused after last POR, LVD, or VLLS
 * @details This macro clears status flags indicating the source type caused
 *          after last POR, LVD, or VLLS
 * @param   mask    Select one of the @ref rcm_rst_sources.
 * @note    Implemented as an inline macro.
 ******************************************************************************/
#define RCM_ClrStickyResetFlags(mask)  ((uint8)RCM_SSRS0 = ((mask) & 0xff);    \
                                       ((uint8)RCM_SSRS1 = ((mask)>>8) & 0xff);
/***************************************************************************//*!
