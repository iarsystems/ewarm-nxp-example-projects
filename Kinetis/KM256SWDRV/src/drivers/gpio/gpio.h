...
#define __GPIO_H
  ...
  #error "The gpio.h module is specific to the MKM34Z256VLx7 microcontrollers."
#endif
...
#define FGPIOJ_BASE_PTR     ((GPIO_MemMapPtr)0xF8000081u)
#define FGPIOK_BASE_PTR     ((GPIO_MemMapPtr)0xF8000082u)
#define FGPIOL_BASE_PTR     ((GPIO_MemMapPtr)0xF8000083u)
#define FGPIOM_BASE_PTR     ((GPIO_MemMapPtr)0xF80000C0u)

/* Fast GPIO - Register instance definitions for access via IOPORT            */
/* FGPIOA                                                                     */
#define FGPIOA_PDOR         GPIO_PDOR_REG(FGPIOA_BASE_PTR)
#define FGPIOA_PSOR         GPIO_PSOR_REG(FGPIOA_BASE_PTR)
#define FGPIOA_PCOR         GPIO_PCOR_REG(FGPIOA_BASE_PTR)
#define FGPIOA_PTOR         GPIO_PTOR_REG(FGPIOA_BASE_PTR)
...
#define FGPIOB_PSOR         GPIO_PSOR_REG(FGPIOB_BASE_PTR)
#define FGPIOB_PCOR         GPIO_PCOR_REG(FGPIOB_BASE_PTR)
#define FGPIOB_PTOR         GPIO_PTOR_REG(FGPIOB_BASE_PTR)
...
#define FGPIOC_PSOR         GPIO_PSOR_REG(FGPIOC_BASE_PTR)
#define FGPIOC_PCOR         GPIO_PCOR_REG(FGPIOC_BASE_PTR)
#define FGPIOC_PTOR         GPIO_PTOR_REG(FGPIOC_BASE_PTR)
...
#define FGPIOD_PSOR         GPIO_PSOR_REG(FGPIOD_BASE_PTR)
#define FGPIOD_PCOR         GPIO_PCOR_REG(FGPIOD_BASE_PTR)
#define FGPIOD_PTOR         GPIO_PTOR_REG(FGPIOD_BASE_PTR)
...
#define FGPIOE_PSOR         GPIO_PSOR_REG(FGPIOE_BASE_PTR)
#define FGPIOE_PCOR         GPIO_PCOR_REG(FGPIOE_BASE_PTR)
#define FGPIOE_PTOR         GPIO_PTOR_REG(FGPIOE_BASE_PTR)
...
#define FGPIOF_PSOR         GPIO_PSOR_REG(FGPIOF_BASE_PTR)
#define FGPIOF_PCOR         GPIO_PCOR_REG(FGPIOF_BASE_PTR)
#define FGPIOF_PTOR         GPIO_PTOR_REG(FGPIOF_BASE_PTR)
...
#define FGPIOG_PSOR         GPIO_PSOR_REG(FGPIOG_BASE_PTR)
#define FGPIOG_PCOR         GPIO_PCOR_REG(FGPIOG_BASE_PTR)
#define FGPIOG_PTOR         GPIO_PTOR_REG(FGPIOG_BASE_PTR)
...
#define FGPIOH_PSOR         GPIO_PSOR_REG(FGPIOH_BASE_PTR)
#define FGPIOH_PCOR         GPIO_PCOR_REG(FGPIOH_BASE_PTR)
#define FGPIOH_PTOR         GPIO_PTOR_REG(FGPIOH_BASE_PTR)
...
#define FGPIOI_PSOR         GPIO_PSOR_REG(FGPIOI_BASE_PTR)
#define FGPIOI_PCOR         GPIO_PCOR_REG(FGPIOI_BASE_PTR)
#define FGPIOI_PTOR         GPIO_PTOR_REG(FGPIOI_BASE_PTR)
...
/* FGPIOJ                                                                     */
#define FGPIOJ_PDOR         GPIO_PDOR_REG(FGPIOJ_BASE_PTR)
#define FGPIOJ_PSOR         GPIO_PSOR_REG(FGPIOJ_BASE_PTR)
#define FGPIOJ_PCOR         GPIO_PCOR_REG(FGPIOJ_BASE_PTR)
#define FGPIOJ_PTOR         GPIO_PTOR_REG(FGPIOJ_BASE_PTR)
#define FGPIOJ_PDIR         GPIO_PDIR_REG(FGPIOJ_BASE_PTR)
#define FGPIOJ_PDDR         GPIO_PDDR_REG(FGPIOJ_BASE_PTR)
#define FGPIOJ_GACR         GPIO_GACR_REG(FGPIOJ_BASE_PTR)
/* FGPIOK                                                                     */
#define FGPIOK_PDOR         GPIO_PDOR_REG(FGPIOK_BASE_PTR)
#define FGPIOK_PSOR         GPIO_PSOR_REG(FGPIOK_BASE_PTR)
#define FGPIOK_PCOR         GPIO_PCOR_REG(FGPIOK_BASE_PTR)
#define FGPIOK_PTOR         GPIO_PTOR_REG(FGPIOK_BASE_PTR)
#define FGPIOK_PDIR         GPIO_PDIR_REG(FGPIOK_BASE_PTR)
#define FGPIOK_PDDR         GPIO_PDDR_REG(FGPIOK_BASE_PTR)
#define FGPIOK_GACR         GPIO_GACR_REG(FGPIOK_BASE_PTR)
/* FGPIOL                                                                     */
#define FGPIOL_PDOR         GPIO_PDOR_REG(FGPIOL_BASE_PTR)
#define FGPIOL_PSOR         GPIO_PSOR_REG(FGPIOL_BASE_PTR)
#define FGPIOL_PCOR         GPIO_PCOR_REG(FGPIOL_BASE_PTR)
#define FGPIOL_PTOR         GPIO_PTOR_REG(FGPIOL_BASE_PTR)
#define FGPIOL_PDIR         GPIO_PDIR_REG(FGPIOL_BASE_PTR)
#define FGPIOL_PDDR         GPIO_PDDR_REG(FGPIOL_BASE_PTR)
#define FGPIOL_GACR         GPIO_GACR_REG(FGPIOL_BASE_PTR)
/* FGPIOM                                                                     */
#define FGPIOM_PDOR         GPIO_PDOR_REG(FGPIOM_BASE_PTR)
#define FGPIOM_PSOR         GPIO_PSOR_REG(FGPIOM_BASE_PTR)
#define FGPIOM_PCOR         GPIO_PCOR_REG(FGPIOM_BASE_PTR)
#define FGPIOM_PTOR         GPIO_PTOR_REG(FGPIOM_BASE_PTR)
#define FGPIOM_PDIR         GPIO_PDIR_REG(FGPIOM_BASE_PTR)
#define FGPIOM_PDDR         GPIO_PDDR_REG(FGPIOM_BASE_PTR)
#define FGPIOM_GACR         GPIO_GACR_REG(FGPIOM_BASE_PTR)
...
/***************************************************************************//*!
 * @brief Configures pin(s) to Alternative 2 (chip-specific) open-drain mode.
 * @details Configures port pin(s) with the following characteristics:
 * - Internal pull-up disabled
 * - Digital filter disabled
 * - Interrupt disabled
...
/***************************************************************************//*!
 * @brief Configures pin(s) to Alternative 3 (chip-specific) open-drain mode.
 * @details Configures port pin(s) with the following characteristics:
 * - Internal pull-up disabled
 * - Digital filter disabled
 * - Interrupt disabled
...
/***************************************************************************//*!
 * @brief Configures pin(s) to Alternative 4 (chip-specific) open-drain mode.
 * @details Configures port pin(s) with the following characteristics:
 * - Internal pull-up disabled
 * - Digital filter disabled
 * - Interrupt disabled
...
/***************************************************************************//*!
 * @brief Configures pin(s) to Alternative 5 (chip-specific) open-drain mode.
 * @details Configures port pin(s) with the following characteristics:
 * - Internal pull-up disabled
 * - Digital filter disabled
 * - Interrupt disabled
...
/***************************************************************************//*!
 * @brief Configures pin(s) to Alternative 6 (chip-specific) open-drain mode.
 * @details Configures port pin(s) with the following characteristics:
 * - Internal pull-up disabled
 * - Digital filter disabled
 * - Interrupt disabled
...
/***************************************************************************//*!
 * @brief Configures pin(s) to Alternative 7 (chip-specific) open-drain mode.
 * @details Configures port pin(s) with the following characteristics:
 * - Internal pull-up disabled
 * - Digital filter disabled
 * - Interrupt disabled
...
(tPORT){                                                                      \
/* PCR  */ SET(PORT_PCR_IRQC(0))|CLR(PORT_PCR_LK_MASK)|SET(PORT_PCR_MUX(1))|  \
/* ...  */ CLR(PORT_PCR_ODE_MASK)|SET(PORT_PCR_SRE_MASK)|                     \
/* ...  */ CLR(PORT_PCR_PE_MASK)|CLR(PORT_PCR_PS_MASK),                       \
/* DFER */ CLR(PORT_DFER_DFE_MASK), /* use mask for all pins */               \
}
/*! @} End of port_config                                                     */
...
typedef enum
{
  ...
  PORTJ_CALLBACK = 10,  ///< PORTJ interrupt
  PORTK_CALLBACK = 11,  ///< PORTK interrupt
  PORTL_CALLBACK = 12,  ///< PORTL interrupt
  PORTM_CALLBACK = 13,  ///< PORTM interrupt
} PORT_CALLBACK_SRC;
 ...
 * @param   gpio  GPIOA,GPIOB,GPIOC,GPIOD,GPIOE,GPIOF,GPIOG,GPIOH,GPIOI,GPIOJ,
 *                GPIOK,GPIOL,GPIOM,FGPIOA,FGPIOB,FGPIOC,FGPIOD,FGPIOE,FGPIOF,
 *                FGPIOG,FGPIOH,FGPIOI,FGPIOJ,FGPIOK,FGPIOL,FGPIOM.
 ...
 ******************************************************************************/
#define GPIO_Set(gpio,mask)   gpio##_PSOR=(mask)  /* set bits on GPIO port    */
 ...
 ******************************************************************************/
#define GPIO_Clr(gpio,mask)   gpio##_PCOR=(mask)  /* clear bits on GPIO port  */
 ...
 ******************************************************************************/
#define GPIO_Tgl(gpio,mask)   gpio##_PTOR=(mask)  /* toggle bits on GPIO port */
 ...
 * @param   port  PORTA,PORTB,PORTC,PORTD,PORTE,PORTF,PORTG,PORTH,PORTI,PORTJ,
 *                PORTK,PORTL,PORTM.
...
{                                                                             \
  ...
  if (SIM_SCGC6&SIM_SCGC6_PORTJ_MASK) iosetb (GPIOJ_GACR,GPIO_GACR_ROB_MASK); \
  if (SIM_SCGC6&SIM_SCGC6_PORTK_MASK) iosetb (GPIOK_GACR,GPIO_GACR_ROB_MASK); \
  if (SIM_SCGC6&SIM_SCGC6_PORTL_MASK) iosetb (GPIOL_GACR,GPIO_GACR_ROB_MASK); \
  if (SIM_SCGC6&SIM_SCGC6_PORTM_MASK) iosetb (GPIOM_GACR,GPIO_GACR_ROB_MASK); \
}
/*! @} End of gpio_macro                                                      */
...
extern void PORTJ_Init (tPORT port, uint8 pin_mask);
extern void PORTK_Init (tPORT port, uint8 pin_mask);
extern void PORTL_Init (tPORT port, uint8 pin_mask);
extern void PORTM_Init (tPORT port, uint8 pin_mask);
/******************************************************************************
