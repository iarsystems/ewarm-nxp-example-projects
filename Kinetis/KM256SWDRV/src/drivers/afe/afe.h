...
#define __AFE_H
  ...
  #error "The afe.h module is specific to the MKM34Z256VLx7 microcontrollers."
#endif
...
#define CH2_GainCtrl(gain)                                                    \
{                                                                             \
  if (gain == PGA_DISABLE)                                                    \
  {                                                                           \
    ioclrw (AFE_CH2_CFR,AFE_CFR_PGA_EN_MASK);                                 \
  }                                                                           \
  else                                                                        \
  {                                                                           \
    iosetw (AFE_CH2_CFR,AFE_CFR_PGA_EN_MASK);                                 \
    iobfiw (AFE_CH2_CFR,AFE_CFR_PGA_GAIN_SEL_SHIFT,3,gain);                   \
  }                                                                           \
}
#define CH3_GainCtrl(gain)                                                    \
{                                                                             \
  if (gain == PGA_DISABLE)                                                    \
  {                                                                           \
    ioclrw (AFE_CH3_CFR,AFE_CFR_PGA_EN_MASK);                                 \
  }                                                                           \
  else                                                                        \
  {                                                                           \
    iosetw (AFE_CH3_CFR,AFE_CFR_PGA_EN_MASK);                                 \
    iobfiw (AFE_CH3_CFR,AFE_CFR_PGA_GAIN_SEL_SHIFT,3,gain);                   \
  }                                                                           \
}
/***************************************************************************//*!
