...
#define __AIPS_H
  ...
  #error "The aips.h module is specific to the MKM34Z256VLx7 microcontrollers."
#endif
...
#define AIPS_DMUX_SLOT    (int64)(1ll<< 4)  ///< Slot 33: Direct Memory Access Multiplexer (DMAMUX)
#define AIPS_RNGA_SLOT    (int64)(1ll<< 5)  ///< Slot 41: Random Number Generator Accelerator (RNGA)
#define AIPS_LPUART_SLOT  (int64)(1ll<< 6)  ///< Slot 42: Low-Power Universal Asynchronous Receiver/Transmitter (LPUART)
#define AIPS_ADC_SLOT     (int64)(1ll<< 7)  ///< Slot 43: SAR Analog-to-Digital Converter (ADC)
#define AIPS_PIT0_SLOT    (int64)(1ll<< 8)  ///< Slot 45: Programmable Interval Timer 0 (PIT0)
#define AIPS_PIT1_SLOT    (int64)(1ll<< 9)  ///< Slot 46: Programmable Interval Timer 1 (PIT1)
#define AIPS_AFE_SLOT     (int64)(1ll<<10)  ///< Slot 48: Analog Front End (AFE)
#define AIPS_CRC_SLOT     (int64)(1ll<<11)  ///< Slot 52: Programmable CRC (CRC)
#define AIPS_PDB_SLOT     (int64)(1ll<<12)  ///< Slot 54: Programmable delay block (PDB0)
#define AIPS_PORTJ_SLOT   (int64)(1ll<<13)  ///< Slot 55: Port J Pin Mux Control (PORTJ)
#define AIPS_PORTK_SLOT   (int64)(1ll<<14)  ///< Slot 56: Port K Pin Mux Control (PORTK)
#define AIPS_PORTL_SLOT   (int64)(1ll<<15)  ///< Slot 57: Port L Pin Mux Control (PORTL)
#define AIPS_PORTM_SLOT   (int64)(1ll<<16)  ///< Slot 58: Port M Pin Mux Control (PORTM)
#define AIPS_LPTMR_SLOT   (int64)(1ll<<17)  ///< Slot 60: Low Power Timer (LPTMR)
#define AIPS_SIMLP_SLOT   (int64)(1ll<<18)  ///< Slot 62: System Integration Module Low Power Logic (SIMLP)
#define AIPS_SIMHP_SLOT   (int64)(1ll<<19)  ///< Slot 63: System Integration Module Low Power Logic (SIMHP)
#define AIPS_SLCD_SLOT    (int64)(1ll<<20)  ///< Slot 67: Segment LCD (SLCD)
#define AIPS_PORTA_SLOT   (int64)(1ll<<21)  ///< Slot 70: Port A Pin Mux Control (PORTA)
#define AIPS_PORTB_SLOT   (int64)(1ll<<22)  ///< Slot 71: Port B Pin Mux Control (PORTB)
#define AIPS_PORTC_SLOT   (int64)(1ll<<23)  ///< Slot 72: Port C Pin Mux Control (PORTC)
#define AIPS_PORTD_SLOT   (int64)(1ll<<24)  ///< Slot 73: Port D Pin Mux Control (PORTD)
#define AIPS_PORTE_SLOT   (int64)(1ll<<25)  ///< Slot 74: Port E Pin Mux Control (PORTE)
#define AIPS_PORTF_SLOT   (int64)(1ll<<26)  ///< Slot 75: Port F Pin Mux Control (PORTF)
#define AIPS_PORTG_SLOT   (int64)(1ll<<27)  ///< Slot 76: Port G Pin Mux Control (PORTG)
#define AIPS_PORTH_SLOT   (int64)(1ll<<28)  ///< Slot 77: Port H Pin Mux Control (PORTH)
#define AIPS_PORTI_SLOT   (int64)(1ll<<29)  ///< Slot 78: Port I Pin Mux Control (PORTI)
#define AIPS_IRTC_SLOT    (int64)(1ll<<30)  ///< Slot 80: Independent Real Time Clock (IRTC)
#define AIPS_IRTCRAM_SLOT (int64)(1ll<<31)  ///< Slot 81: IRTC's 32-byte Standby RAM (IRTCRAM)
#define AIPS_WDOG_SLOT    (int64)(1ll<<32)  ///< Slot 83: Watchdog Timer (WDOG)
#define AIPS_XBAR_SLOT    (int64)(1ll<<33)  ///< Slot 85: Peripheral Crossbar (XBAR)
#define AIPS_TMR0_SLOT    (int64)(1ll<<34)  ///< Slot 87: Quad Timer Channel 0 (TMR0)
#define AIPS_TMR1_SLOT    (int64)(1ll<<35)  ///< Slot 88: Quad Timer Channel 1 (TMR1)
#define AIPS_TMR2_SLOT    (int64)(1ll<<36)  ///< Slot 89: Quad Timer Channel 2 (TMR2)
#define AIPS_TMR3_SLOT    (int64)(1ll<<37)  ///< Slot 90: Quad Timer Channel 3 (TMR3)
#define AIPS_EWM_SLOT     (int64)(1ll<<38)  ///< Slot 97: External Watchdog Monitor (EWM)
#define AIPS_MCG_SLOT     (int64)(1ll<<39)  ///< Slot 100: Multipurpose Clock Generator (MCG)
#define AIPS_OSC_SLOT     (int64)(1ll<<40)  ///< Slot 102: MHz Oscillator (OSC)
#define AIPS_I2C0_SLOT    (int64)(1ll<<41)  ///< Slot 103: Inter-Integrated Circuit 0 (I2C0)
#define AIPS_I2C1_SLOT    (int64)(1ll<<42)  ///< Slot 104: Inter-Integrated Circuit 1 (I2C1)
#define AIPS_UART0_SLOT   (int64)(1ll<<43)  ///< Slot 106: Universal Asynchronous Receiver/Transmitter 0 (UART0)
#define AIPS_UART1_SLOT   (int64)(1ll<<44)  ///< Slot 107: Universal Asynchronous Receiver/Transmitter 1 (UART1)
#define AIPS_UART2_SLOT   (int64)(1ll<<45)  ///< Slot 108: Universal Asynchronous Receiver/Transmitter 2 (UART2)
#define AIPS_UART3_SLOT   (int64)(1ll<<46)  ///< Slot 109: Universal Asynchronous Receiver/Transmitter 3 (UART3)
#define AIPS_VREF_SLOT    (int64)(1ll<<47)  ///< Slot 111: 1.2V Voltage Reference (VREF)
#define AIPS_CMP_SLOT     (int64)(1ll<<48)  ///< Slot 114: Comparator (CMP)
#define AIPS_SPI0_SLOT    (int64)(1ll<<49)  ///< Slot 117: Serial Peripheral Interface 0 (SPI0)
#define AIPS_SPI1_SLOT    (int64)(1ll<<50)  ///< Slot 118: Serial Peripheral Interface 1 (SPI1)
#define AIPS_RCM_SLOT     (int64)(1ll<<51)  ///< Slot 123: Reset Control Module (RCM)
#define AIPS_LLWU_SLOT    (int64)(1ll<<52)  ///< Slot 124: Low Leakage Wakeup Unit (LLWU)
#define AIPS_PMC_SLOT     (int64)(1ll<<53)  ///< Slot 125: Power Management Controller (PMC)
#define AIPS_SMC_SLOT     (int64)(1ll<<54)  ///< Slot 126: System Mode Controller (SMC)
#define AIPS_ALL_SLOTS   0xfffffffffffffff  ///< Selects all slots
/*! @} End of aips_slot                                                       */
...
#define PACR_DMUX_SLOT    {(uint32*)&AIPS_PACRE,AIPS_PACRM_AC1_SHIFT}/* PACR 33 */

#define PACR_RNGA_SLOT    {(uint32*)&AIPS_PACRF,AIPS_PACRM_AC1_SHIFT}/* PACR 41 */
#define PACR_LPUART_SLOT  {(uint32*)&AIPS_PACRF,AIPS_PACRM_AC2_SHIFT}/* PACR 42 */
...
#define PACR_PDB_SLOT     {(uint32*)&AIPS_PACRG,AIPS_PACRM_AC6_SHIFT}/* PACR 54 */
#define PACR_PORTJ_SLOT   {(uint32*)&AIPS_PACRG,AIPS_PACRM_AC7_SHIFT}/* PACR 55 */

#define PACR_PORTK_SLOT   {(uint32*)&AIPS_PACRH,AIPS_PACRM_AC0_SHIFT}/* PACR 56 */
#define PACR_PORTL_SLOT   {(uint32*)&AIPS_PACRH,AIPS_PACRM_AC1_SHIFT}/* PACR 57 */
#define PACR_PORTM_SLOT   {(uint32*)&AIPS_PACRH,AIPS_PACRM_AC2_SHIFT}/* PACR 58 */
...
{                                                                                \
  ...
  if ((mask) & AIPS_DMUX_SLOT   ) _AIPS_SET_ATTR(PACR_DMUX_SLOT   , attr, lock); \
  if ((mask) & AIPS_RNGA_SLOT   ) _AIPS_SET_ATTR(PACR_RNGA_SLOT   , attr, lock); \
  if ((mask) & AIPS_LPUART_SLOT ) _AIPS_SET_ATTR(PACR_LPUART_SLOT , attr, lock); \
  ...
  if ((mask) & AIPS_PDB_SLOT    ) _AIPS_SET_ATTR(PACR_PDB_SLOT    , attr, lock); \
  if ((mask) & AIPS_PORTJ_SLOT  ) _AIPS_SET_ATTR(PACR_PORTJ_SLOT  , attr, lock); \
  if ((mask) & AIPS_PORTK_SLOT  ) _AIPS_SET_ATTR(PACR_PORTK_SLOT  , attr, lock); \
  if ((mask) & AIPS_PORTL_SLOT  ) _AIPS_SET_ATTR(PACR_PORTL_SLOT  , attr, lock); \
  if ((mask) & AIPS_PORTM_SLOT  ) _AIPS_SET_ATTR(PACR_PORTM_SLOT  , attr, lock); \
...
{                                                                                \
  ...
  _AIPS_LOCK(PACR_DMUX_SLOT   );                                                 \
  _AIPS_LOCK(PACR_RNGA_SLOT   );                                                 \
  _AIPS_LOCK(PACR_LPUART_SLOT );                                                 \
  ...
  _AIPS_LOCK(PACR_PDB_SLOT    );                                                 \
  _AIPS_LOCK(PACR_PORTJ_SLOT  );                                                 \
  _AIPS_LOCK(PACR_PORTK_SLOT  );                                                 \
  _AIPS_LOCK(PACR_PORTL_SLOT  );                                                 \
  _AIPS_LOCK(PACR_PORTM_SLOT  );                                                 \
