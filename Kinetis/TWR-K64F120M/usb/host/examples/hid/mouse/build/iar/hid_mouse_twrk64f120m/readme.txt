...
DESCRIPTION
===========
  This is an example of device drivers for a Mouse device. The program
...
===============
  ...
  4) Connect a mouse to the K64_USB port. An adapter from micro-USB
