...
DESCRIPTION
===========
  This is an example of device drivers for the HID class. This example
  demonstrates the keyboard functionality. Note that a real keyboard
  driver also needs to distinguish between intentionally repeated and
  unrepeated key presses. This example simply demonstrates how to receive
  data from a USB Keyboard. 
...
===============
  ...
  4) Connect a keyboard to the K64_USB port. An adapter from micro-USB
  to USB-A may be needed.
