...
DESCRIPTION
===========
  This example executes the standard "mass storage device" commands to
  the USB disk and shows the response on the serial console (see MFS
  examples for USB filesystem access).
...
===============
  ...
  4) Connect an USB flash drive (MSD) to the K64_USB port. An adapter from
