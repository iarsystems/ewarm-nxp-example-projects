...
DESCRIPTION
===========
  This example implements a virtual network interface card.

  Note: USB RNDIS device driver can be found at:

  $PROJ_DIR$\..\..\..\inf

  where $PROJ_DIR$ is the cdc_vnic_twrk64f120m.ewp project folder.
...
===============
  ...
  5) Install the RNDIS driver when prompted.
