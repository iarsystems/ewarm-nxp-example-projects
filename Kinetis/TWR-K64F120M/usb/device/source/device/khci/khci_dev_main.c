...
#define INTEN_BUS_RESET_VAL     (0x9F) /* Value to enable interrupts in bus reset */
    ...
    static __no_init  uint8_t bdt[512] @ "USB_BDT_Z";
...
static volatile uint16_t tdl_index = 0;
static volatile struct tk_dne_log tdl[1024] = { 0 }; /* note, the array is for 1024 records only */
static volatile uint16_t pkb_index = 0;
static volatile uint8_t pkb[1024][8] = { 0 };
static volatile uint32_t pkbaddr[1024] = { 0 };
