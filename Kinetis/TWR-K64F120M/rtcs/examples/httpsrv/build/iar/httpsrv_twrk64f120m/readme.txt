...
DESCRIPTION
===========
  The example is a simple web server with CGI-like scripts and web pages
  stored in internal flash. The default IP address of the web server is
  192.168.0.202
  ...
  all configurations.
  Note: If the need libraries are already build in other example, this step
  may be skipped.
