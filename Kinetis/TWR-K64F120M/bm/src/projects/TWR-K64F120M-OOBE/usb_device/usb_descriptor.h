...
const uint8 Configuration_Descriptor[0x43] = {
	...
	0x09,			/* blength */
	0x02,			/* bDescriptor */
	0x43, 0x00,		/* wTotalLength - # of bytes including interface */
					/*				  and endpoint descpt. */
...
/* Interface Descriptor */
	...
	0x00,			/* bInterfaceNumber - Zero based value identifying */
					/*					  the index of the config. */
...
/* Interface Descriptor */
	0x09,			/* blength */
	0x04,			/* bDescriptorType - Interface descriptor */
	0x01,			/* bInterfaceNumber - Zero based value identifying */
					/*					  the index of the config. */
	0x00,			/* bAlternateSetting; */
