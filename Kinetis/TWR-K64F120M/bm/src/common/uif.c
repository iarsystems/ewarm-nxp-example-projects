...
const char HELPMSG[] = "Enter 'help' for help.\n";
...
uint32 get_value(char *s, int *success, int base)
{
	uint32 value;
	char *p;
...
void uif_cmd_help(int argc, char **argv)
{
	int index;
...
void uif_cmd_set(int argc, char **argv)
{
	int index;
...
void uif_cmd_show(int argc, char **argv)
{
	int index;
