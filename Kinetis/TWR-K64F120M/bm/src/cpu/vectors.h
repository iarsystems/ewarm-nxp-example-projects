...
#define VECTOR_039	default_isr			// 0x0000_009C	39	23		RNG Randon Number Generator
...
#define VECTOR_051	default_isr			// 0x0000_00CC	51	35		UART2
#define VECTOR_052	default_isr			// 0x0000_00D0	52	36		UART2
...
#define VECTOR_069	default_isr			// 0x0000_0114	69	53		USB OTG —
#define VECTOR_070	default_isr			// 0x0000_0118	70	54		USB Charger Detect —
...
#define VECTOR_083	default_isr			// 0x0000_014C	83	67    UART4 Single interrupt vector for UART error sources
#define VECTOR_084	default_isr			// 0x0000_0150	84	68		UART5 Single interrupt vector for UART status sources
#define VECTOR_085	default_isr			// 0x0000_0154	85	69		UART5 Single interrupt vector for UART error sources
