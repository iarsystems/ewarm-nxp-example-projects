/*
 *  CAU Header File
 *  Works with library cau_lib.a and lib_mmcau*.a (mmcau_lib.a)
 *  Define NXP_CAU if CAU coprocessor is used --Register parameter passing is assumed
 *  Define NXP_MMCAU if mmCAU coprocessor is used --EABI for Kinetis ARM Cortex-Mx
 *  12/19/2013
 */
