...
void sai_mode_config(unsigned char port, unsigned char tx,
					 unsigned char mode, unsigned char bcs,
					 unsigned char bci);
...
void sai_channel_enable(unsigned char port,
						unsigned char tx,
						unsigned char chen);
void sai_channel_disable(unsigned char port,
						 unsigned char tx,
						 unsigned char chen);
...
unsigned char sai_rx(unsigned char port, unsigned char channel,
					 unsigned int *rxdata);
void sai_wr_tdr(unsigned char port, unsigned char channel,
				unsigned int txdata);
void sai_rd_rdr(unsigned char port, unsigned char channel,
				unsigned int *rxdata);
...
void sai_mclk_config(unsigned char port, unsigned char mics,
					 unsigned char moe, unsigned char fract,
