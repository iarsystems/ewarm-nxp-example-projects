...
DESCRIPTION
===========
  This example shows custom task queue and how the queue can be suspended
  and resumed.
  There is a task that creates the task queue and the simulated_ISR_task
  task. Then it enters an infinite loop, printing "Tick" and suspending
  the task queue.
