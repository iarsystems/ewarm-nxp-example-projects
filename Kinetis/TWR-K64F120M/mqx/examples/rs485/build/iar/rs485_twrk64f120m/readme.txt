...
DESCRIPTION
===========
  The example rs485 shows how to use the RS485 driver. There are 2 tasks, 
  the first one writes data to RS485, and the second one reads RS485 data.
