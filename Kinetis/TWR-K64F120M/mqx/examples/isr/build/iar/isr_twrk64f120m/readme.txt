...
DESCRIPTION
===========
   This project is an isr example program. A task installs a new ISR to
   replace the timer ISR. It then waits for some time, finally printing out
   the number of times the ISR ran.
