...
DESCRIPTION
===========
  This example shows how to use the LWGPIO driver to control on-board
  LEDs and switches. Press the SW1 on the board. The status will be shown
  on terminal.
