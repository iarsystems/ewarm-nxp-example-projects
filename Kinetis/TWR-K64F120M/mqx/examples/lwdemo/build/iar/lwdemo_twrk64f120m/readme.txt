...
DESCRIPTION
===========
  This example is a Lightweight MQX demo test. It shows MQX multitasking
  and inter-process communication using lightweight objects like semaphores,
  events, or messages.
