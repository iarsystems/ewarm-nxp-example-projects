...
DESCRIPTION
===========
  The example demonstrates use of an alternate UART port as a console output.
...
=============
  ...
  The application uses the serial interface on the TWR-SER board and the serial
  interface via the onboard debugger USB port.
