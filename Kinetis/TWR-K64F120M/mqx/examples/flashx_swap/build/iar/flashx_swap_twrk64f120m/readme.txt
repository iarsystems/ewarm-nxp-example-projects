...
DESCRIPTION
===========
  This example write an user message to upper flashspace and then perform
  swap_and_reset. After reset the application read the message from lower
  flash space.
