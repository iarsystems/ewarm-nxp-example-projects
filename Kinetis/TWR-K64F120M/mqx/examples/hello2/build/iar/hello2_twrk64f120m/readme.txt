...
DESCRIPTION
===========
  This example shows how to create 2 tasks in MQX RTOS. The first task
  outputs "Hello" and the second one outputs "World" on the terminal screen.
