...
DESCRIPTION
===========
  The RTC example synchronizes the RTC module time with MQX RTOS system
  time, sets the minute stopwatch interrupt and handler, sets the second
  alarm interrupt and handler.
