...
DESCRIPTION
===========
  This example finds a string at 'the end' of flash memory then it tries
  to rewrite it. The successfull rewrite can be proved by re-executing 
  the application.
