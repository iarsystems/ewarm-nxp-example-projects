...
copy %ROOTDIR%\mqx\source\io\flashx\NXP\flash_mk64.h %OUTPUTDIR%\flash_mk64.h /Y
...
copy %ROOTDIR%\mqx\source\io\flashx\NXP\flash_ftfe.h %OUTPUTDIR%\flash_ftfe.h /Y
