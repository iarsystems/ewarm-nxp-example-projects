...
typedef intu8 ContinuaStructType;
...
typedef intu16 RegulationBitFieldType;
#define UNREGULATED_DEVICE              0
#define REGULATED_DEVICE                1

typedef struct _ContinuaRegStruct
{
    RegulationBitFieldType regulation_bit_field;
} ALIGN  ContinuaRegStruct;

typedef struct _CertifiedDeviceClassList
{
    intu16 count;
    intu16 length;
    CertifiedDeviceClassEntry value[1];
} ALIGN  CertifiedDeviceClassList;
typedef struct _ContinuaBodyStruct
{
    intu8 major_ig_version;
    intu8 minor_ig_version;
    CertifiedDeviceClassList certified_devices;
} ALIGN  ContinuaBodyStruct;
typedef struct _AuthBodyStructType
{
	intu8 authbody;
	...
	intu8 authbodystructtype;
}  ALIGN  AuthBodyStructType;

typedef struct _RegCertData
{
	AuthBodyStructType authbody;
	Any authbodydata;
} ALIGN  RegCertData;

typedef struct _RegCertDataList
{
    intu16 count;
    intu16 length;
    RegCertData value[1];
} ALIGN  RegCertDataList;
...
#define DATA_REQ_SUPP_STOP 0x0080
#define DATA_REQ_SUPP_SCOPE_ALL 0x0008
#define DATA_REQ_SUPP_SCOPE_CLASS 0x0004
#define DATA_REQ_SUPP_SCOPE_HANDLE 0x0002
#define DATA_REQ_SUPP_MODE_SINGLE_RSP 0x8000
#define DATA_REQ_SUPP_MODE_TIME_PERIOD 0x4000
#define DATA_REQ_SUPP_MODE_TIME_NO_LIMIT 0x2000
#define DATA_REQ_SUPP_PERSON_ID 0x1000
#define DATA_REQ_SUPP_INIT_AGENT 0x0100
...
#define TIME_SYNC_ACCURACY_UNKNOWN      0xFFFFFFFF

#define TIME_RESOLUTION_UNKNOWN    0x0
...
} ALIGN ScanReportInfoGroupedList;
...
} ALIGN ScanReportPerGroupedList;
