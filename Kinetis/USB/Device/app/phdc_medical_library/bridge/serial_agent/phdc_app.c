...
void UpdateBPMeasurements(void)
{
    ...
    BloodPressure[5]++;
    BloodPressure[7]++;
    BloodPressure[9] = (intu8)((BloodPressure[5] + BloodPressure[7])/2);
}
/******************************************************************************
 *
 *   @name        UpdateTime
...
{    
    ...
    AgentSendAssociationRequest((DataProtoList*)g_DataProtoList);
}
/******************************************************************************
 *
