...
=============
  ...
  The example project is compatible with Freescale TWR-K40/K53/K60 board.
  By default, the project is configured to use the J-Link JTAG interface.
 
CONFIGURATION
=============
  The Workspace contains USB serial bridge example with few configurations.
...
===============
  ...
  2) Select File->Open->Workspace...
     Open the following workspace:
      ...
      Source\Device\app\bridgeserial_bridge\iar_ew\
      kinetis\USB_SER_BRIDGE.eww
