...
USB_DESC_CONST USB_CLASS_PHDC_CHANNEL_INFO usb_desc_ep = { PHDC_DESC_ENDPOINT_COUNT,
                                      {PHDC_BULK_OUT_EP,
                                       USB_BULK_PIPE,
                                       USB_RECV,
...
USB_PACKET_SIZE USB_DESC_CONST g_std_desc_size[USB_MAX_STD_DESCRIPTORS+1] =
                                    {0,
...
uint_8_ptr USB_DESC_CONST g_std_descriptors[USB_MAX_STD_DESCRIPTORS+1] = {
                                                NULL,
