...
===========
  ...
  to develop code for a Embedded Artsists LPC315x evaluation board. It shows
...
===============
  ...
  2) Select File->Open->Workspace...
     ...
     <installation-root>\arm\examples\NXP\LPC315x\EmbArtLPC315x\GettingStarted\GettingStarted.eww
