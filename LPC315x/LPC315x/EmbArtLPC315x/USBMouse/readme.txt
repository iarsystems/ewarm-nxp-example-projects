...
===========
 ...
 to develop code for a Embedded Artsists LPC315x evaluation board. It implements
 USB HID mouse.
...
===============
  ...
  2) Select File->Open->Workspace...
     ...
     <installation-root>\arm\examples\NXP\LPC315x\EmbArtLPC315x\USBMouse\USBMouse.eww
