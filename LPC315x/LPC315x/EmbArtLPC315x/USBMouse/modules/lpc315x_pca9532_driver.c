/***********************************************************************
 * $Id: lpc315x_pca9532_driver.c 28 2014-01-27 14:45:13Z danielru $
 *
...
#include "lpc315x_pca9532_driver.h"
 ...
 *
 **********************************************************************/
STATUS pca9532_ioctl(INT_32 devid, INT_32 cmd, INT_32 arg, INT_32 * val)
{
  ...
  if (((I2C_CFG_T *) devid)->regptr == I2C0) i2c_id = 0;
  if (((I2C_CFG_T *) devid)->regptr == I2C1) i2c_id = 1;
