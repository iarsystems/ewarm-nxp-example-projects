 ...
 *
 *    File name   : dsk_desc.c
 *    Description : disk descriptor
 *
 *    History :
...
// 16 - 31 PRODUCT IDENTIFICATION
  'L','P','C','4','0','8','8','-','S','K',' ','F','l','a','s','h',
// 32 - 35 PRODUCT REVISION LEVEL
  '1','.','0','0',
};

const LunFpnt_t Flash_LunFunDesc =
{
  .DiskInitFpnt   = DiskInit,
  .DiskStatusFpnt = GetDiskCtrlBkl,
  .DiskIoFpnt     = DiskIO,
  .DiskInquiry    = (uint8_t *)DskInquiry,
  .DiskInquirySize = 36
};
