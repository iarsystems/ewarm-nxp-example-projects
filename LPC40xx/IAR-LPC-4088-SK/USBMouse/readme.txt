...
===============
  ...
  1) Open the USBMouse work space.
  ...
  3) If you previously haven't run any of the IAR-LPC4088-SK examples
     ...
     - Switch back to the USBMouse project.

  4) Build the USBMouse example. Press CTRL+D or use Download and
  ...
  7) Move the board around its axis. The PC mouse cursor will move.