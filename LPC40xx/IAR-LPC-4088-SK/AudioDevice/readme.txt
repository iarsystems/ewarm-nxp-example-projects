...
===============
  ...
  1) Open the AudioDevice work space.
  ...
  3) If you previously haven't run any of the IAR-LPC4088-SK examples
     ...
     - Switch back to the AudioDevice project.

  4) Build the AudioDevice example. Press CTRL+D or use Download and
  ...
  7) Plug in headphones to the board's headphones jack. You should be able
     to hear the sounds and the music played on your PC.
     
  8) Press "LOUD" and "WIDE STEREO" buttons on the screen to enable/disable
     the sound effects.