/***********************************************************************
 * $Id: spi_prog.c 28 2014-01-27 14:45:13Z danielru $
 *
...
//    {
      ...
      uart_string_write( "*********************** \r\n"
        ...
        "After power-up try programing again. \r\n"
        "*********************** \r\n");
      return _ERROR;

    }

    uart_string_write("SPI programer is ready for download> \r\n");
    ...
    if (img_len)
    {
      ...
      {
        uart_string_write("Programing flash\r\n");
        /* dump SPI data */
      ...
      else
      {
        ...
        uart_string_write("And select demo.rom file for programing.\r\n");
      }
    }
  }
