/***********************************************************************
 * $Id: lpc313x_ioconf_driver.h 28 2014-01-27 14:45:13Z danielru $
 *
...
#pragma inline 
static  BOOL_32 gpio_get_pin_state(IOCONF_BLOCK_T gpio_block, UNS_32 bitnum)
{
...
#pragma inline 
static void gpio_set_as_input(IOCONF_BLOCK_T gpio_block, UNS_32 bitnum)
{
...
#pragma inline 
static void gpio_set_outpin_high(IOCONF_BLOCK_T gpio_block, UNS_32 bitnum)
{
...
/* Sets GPIO output pin to high state */
#pragma inline 
static void gpio_set_outpin_low(IOCONF_BLOCK_T gpio_block, UNS_32 bitnum)
{
  IOCONF->block[gpio_block].mode1_set = _BIT(bitnum);
  IOCONF->block[gpio_block].mode0_clear = _BIT(bitnum);
}
...
#pragma inline 
static void gpio_set_as_ip_driven(IOCONF_BLOCK_T gpio_block, UNS_32 bitnum)
{
  IOCONF->block[gpio_block].mode1_clear = _BIT(bitnum);
  IOCONF->block[gpio_block].mode0_set = _BIT(bitnum);
}
