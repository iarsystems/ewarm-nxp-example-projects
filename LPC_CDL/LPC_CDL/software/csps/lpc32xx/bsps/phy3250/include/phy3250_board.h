/***********************************************************************
 * $Id: phy3250_board.h 28 2014-01-27 14:45:13Z danielru $
 *
...
/* Structure used to define the hardware for the Phytec board - these
   values are stored in the serial EEPROM */
typedef struct
{
...
#define PHY_NOR_CS_TO_OUT     9090909
...
/***********************************************************************
 * USB OTG transceiver address
 **********************************************************************/
#if PHY3250_MODULEBOARD_1304_X > 1
#define PHY3250_USBOTG_I2C_ADDR 0x2D
#else
#define PHY3250_USBOTG_I2C_ADDR 0x2C
#endif
