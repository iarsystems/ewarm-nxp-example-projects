/***********************************************************************
 * uart_int_1.c 13 2008-09-11 --- editted by HieuNguyen 
 *
...
int c_entry(void)
{
    ...
    if ((uartdev = UART_Init (UART_PORT_1, 9600, 8, 0, 1)) == 0x00)
    {
        return 0;
    }
    
    /* Install UART0 irq */
    if (VIC_InstallIRQ (UART1_INT,(void *)uart1_isr, 0x01) == _ERROR)
    {
    	return 0;
    }
