/***********************************************************************
 * $Id: usbd_msc.c 28 2014-01-27 14:45:13Z danielru $
 *
...
int main (void) 
{
    ...
    SysTick_Config(M4Frequency/1000);               
    ...
    */
    ...
    {                                           
        ...
        /* Toggle LED state */
            ...
            LPC_GPIO_PORT->NOT[3] = (1UL << 6);
#elif defined(USE_ADC_VAL)
            LPC_GPIO_PORT->NOT[1] = (1UL << 1);
#else
