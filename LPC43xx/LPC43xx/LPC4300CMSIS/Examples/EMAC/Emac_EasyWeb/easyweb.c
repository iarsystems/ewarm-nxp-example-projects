...
#include "EMAC.h"         // *.c -> *.h    // ethernet packet driver

#define extern            // Line added for modular project management

#include "easyweb.h"
#include "tcpip.h"        // *.c -> *.h    // easyWEB TCP/IP stack
...
{
// function replaced to handle lpc43xx A/D converter.
  unsigned int val;
  val = ADC_Read();
