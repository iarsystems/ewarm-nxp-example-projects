/**********************************************************************
* $Id: lpc43xx_emc.c 28 2014-01-27 14:45:13Z danielru $		lpc43xx_emc.c		2011-12-07
*//**
* @file		lpc43xx_emc.c
...
void EMCFlashInit(void)
{
	...
	LPC_EMC->STATICWAITRD0 = (uint32_t)DELAYCYCLES(70)+1;

	LPC_EMC->STATICWAITPAG0 = (uint32_t)DELAYCYCLES(70)+1;


	LPC_EMC->CONTROL = 0x01;
	LPC_EMC->STATICCONFIG0 = (1UL<<7) | (1UL);
	LPC_EMC->STATICWAITOEN0 = (uint32_t)DELAYCYCLES(35)+1;
