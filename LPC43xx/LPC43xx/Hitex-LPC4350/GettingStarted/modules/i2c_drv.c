...
int I2C_InitMaster (unsigned long BusSpeed)
{
  ...
  SCU_SFSI2C0_bit.SCL_EZI = 1;
  SCU_SFSI2C0_bit.SDA_EZI = 1;
  ...
  I2C0_SCLH = ((I2C0_PCLK / BusSpeed) / 2) + 1;
  I2C0_SCLL =  (I2C0_PCLK / BusSpeed) / 2;
...
{
unsigned long I2Cstatus = I2C0_STAT & 0xF8;
