...
#pragma section  = "lowerToUpper_sec"
char lowerToUpper[41] @ "lowerToUpper_sec";
#pragma section = "reversed_sec"
char reversed[41] @ "reversed_sec";
#pragma section = "power3_sec"
uint32_t power3 @ "power3_sec";

#define CLOCK_SPEED (204000000UL)
#define COUNTER_VAL 15000 // used to print the stats

/* not needed with EWARM */
...
int main (void) 
{
	...
	/* EWARM: M0 image is already linked in the code */
	*(volatile uint32_t *) SLAVE_SHADOW_REG = SLAVE_ROM_START;
