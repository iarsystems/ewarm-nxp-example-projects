 ...
 *    Description : i.MX25 I2C1 driver
 *
 *    History :
 ...
 * Return: none
 *
 * Description: I2C1 interrupts handler
 *
 *************************************************************************/
...
volatile Int8U Dummy;
  ...
  if(!I2SR1_bit.IAL)
  {
    ...
    case I2cRepeatedStart:
      I2CR1_bit.RSTA = 1;
      I2DR1_bit.DATA = I2C_Ctrl.SlaveAdd;
      ++I2C_Ctrl.State;
      break;
...
void I2C1_Init (void)
{
  ...
  I2C_Ctrl.State  = I2cIdle;
  // Enable a clock
  CGCR0_bit.ipg_per_i2c  = 1;
  CGCR1_bit.ipg_clk_i2c1 = 1;
  ...
  IOMUXC_SW_MUX_CTL_PAD_I2C1_CLK_bit.MUX_MODE = ALT0_MUX_MODE;
  IOMUXC_SW_MUX_CTL_PAD_I2C1_DAT_bit.MUX_MODE = ALT0_MUX_MODE;
  // I2C speed init ~100kHz/IPCLK 66.5MHz
  IFDR1 = 0x11; // /320 133/(4*320) = 104 KHz
  I2SR1_bit.IIF=0;
  I2CR1_bit.IIEN = 1;
  // Init AITC
  ASIC_SetupIntr(I2C1_Handler,FALSE,INT_I2C1,2);
  ASIC_EnableIntSource(INT_I2C1);
}
...
I2cStatus_t I2C1_Transfer(Int8U SlaveAdd, Int8U Add, pInt8U pData, Int32U DataSize)
{
  ...
  I2SR1_bit.IIF=0;
  I2DR1_bit.DATA = I2C_Ctrl.SlaveAdd & 0xFE;
  I2CR1_bit.IIEN = 1;
